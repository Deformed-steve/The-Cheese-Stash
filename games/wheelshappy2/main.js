function getTitleLabel() {
    const labels = [
        'Thecheesestash.netlify.app (passwrd= cheesemasterrulez)',
        'CheeseStash!',
        'Rizzful Version',
        'Shoutouts to TheCheeseStash',
        'Peyton',
        'Quinn, please come back..',
        'Did you get the fat lady or the old man for christmas?!?',
        'Happy day of the month ! If it.. actually is the day of the month..'
    ];
