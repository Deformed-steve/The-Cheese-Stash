function createUnityInstance(t, n, l) {
  ...
  u.SystemInfo = function() {
    ...
    version: 1
  }, b = "RequestStore", g = "WebAssembly", p = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, w = null, C.getInstance = function() {
    return w = w || new C
    ...
    e.objectStoreNames.contains(m.name) || (t = e.createObjectStore(m.name, {
      ...
      t.createIndex(e, e)
    })), e.objectStoreNames.contains(b) && e.deleteObjectStore(b), e.objectStoreNames.contains(g) && e.deleteObjectStore(g)
        ...
        var t, n = {
          ...
          "zlib/inflate.js": function(e, t, n) {
            ...
            n.inflateReset = s, n.inflateReset2 = l, n.inflateResetKeep = i, n.inflateInit = function(e) {
              ...
              var n, r, o, a, i, s, l, c, d, u, f, h, m, b, g, p, w, v, y, k, _, x, S, C, E = 0,
                U = new T.Buf8(4),
              ...
              e: for (;;) switch (n.mode) {
                ...
                case 19:
                  for (; n.have < n.nlen + n.ndist;) {
                    for (; p = (E = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255, w = 65535 & E, !((g = E >>> 24) <= d);) {
                      if (0 === s) break e;
                      s--, c += r[a++] << d, d += 8
                    }
                    if (w < 16) c >>>= g, d -= g, n.lens[n.have++] = w;
                    else {
                      if (16 === w) {
                        for (C = g + 2; d < C;) {
                          if (0 === s) break e;
                        ...
                        _ = 0, h = 3 + (7 & (c >>>= g)), c >>>= 3, d = d - g - 3
                      } else {
                        for (C = g + 7; d < C;) {
                          if (0 === s) break e;
                          s--, c += r[a++] << d, d += 8
                        }
                        _ = 0, h = 11 + (127 & (c >>>= g)), c >>>= 7, d = d - g - 7
                      }
                ...
                case 21:
                  ...
                  for (n.back = 0; p = (E = n.lencode[c & (1 << n.lenbits) - 1]) >>> 16 & 255, w = 65535 & E, !((g = E >>> 24) <= d);) {
                    if (0 === s) break e;
                    s--, c += r[a++] << d, d += 8
                  }
                  if (p && 0 == (240 & p)) {
                    for (v = g, y = p, k = w; p = (E = n.lencode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255, w = 65535 & E, !(v + (g = E >>> 24) <= d);) {
                      if (0 === s) break e;
                      s--, c += r[a++] << d, d += 8
                    }
                    c >>>= v, d -= v, n.back += v
                  }
                  if (c >>>= g, d -= g, n.back += g, n.length = w, 0 === p) {
                    n.mode = 26;
                    break
                  }
                  if (32 & p) {
                ...
                case 23:
                  for (; p = (E = n.distcode[c & (1 << n.distbits) - 1]) >>> 16 & 255, w = 65535 & E, !((g = E >>> 24) <= d);) {
                    if (0 === s) break e;
                    s--, c += r[a++] << d, d += 8
                  }
                  if (0 == (240 & p)) {
                    for (v = g, y = p, k = w; p = (E = n.distcode[k + ((c & (1 << v + y) - 1) >> v)]) >>> 16 & 255, w = 65535 & E, !(v + (g = E >>> 24) <= d);) {
                      if (0 === s) break e;
                      s--, c += r[a++] << d, d += 8
                    }
                    c >>>= v, d -= v, n.back += v
                ...
                for (_ < 15 && (k += d[c++] << _, _ += 8, k += d[c++] << _, _ += 8), n = x[k & C];;) {
                  if (k >>>= r = n >>> 24, _ -= r, 0 == (r = n >>> 16 & 255)) h[f++] = 65535 & n;
                    ...
                    for (o = 65535 & n, (r &= 15) && (_ < r && (k += d[c++] << _, _ += 8), o += k & (1 << r) - 1, k >>>= r, _ -= r), _ < 15 && (k += d[c++] << _, _ += 8, k += d[c++] << _, _ += 8), n = S[k & E];;) {
                      ...
                      if (a = 65535 & n, _ < (r &= 15) && (k += d[c++] << _, (_ += 8) < r && (k += d[c++] << _, _ += 8)), g < (a += k & (1 << r) - 1)) {
          ...
          "zlib/inftrees.js": function(e, t, n) {
            ...
            t.exports = function(e, t, n, r, o, a, i, s) {
              for (var l, c, d, u, f, h, m, b, g, p = s.bits, w = 0, v = 0, y = 0, k = 0, _ = 0, x = 0, S = 0, C = 0, E = 0, U = 0, D = null, B = 0, A = new I.Buf16(16), T = new I.Buf16(16), R = null, P = 0, w = 0; w <= 15; w++) A[w] = 0;
              ...
              if (k < _ && (_ = k), 0 === k) o[a++] = 20971520, o[a++] = 20971520, s.bits = 1;
                ...
                for (;;) {
                  for (g = i[v] < h ? (b = 0, i[v]) : i[v] > h ? (b = R[P + i[v]], D[B + i[v]]) : (b = 96, 0), l = 1 << (m = w - S), y = c = 1 << x; o[f + (U >> S) + (c -= l)] = m << 24 | b << 16 | g | 0, 0 !== c;);
                  for (l = 1 << w - 1; U & l;) l >>= 1;
