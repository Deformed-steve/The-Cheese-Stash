(() => {
  ...
  class e {
    constructor(e) {
      this.gp = e, this.gp.player.on("change", (() => this.trigger("CallPlayerChange"))), this.gp.player.on("sync", (e => {
        ...
        this.trigger("CallOnFetchChannel", JSON.stringify(s(e)))
      })), this.gp.channels.on("error:fetchChannel", (e => this.trigger("CallOnFetchChannelError"))), this.gp.channels.on("fetchChannels", (e => {
        this.trigger("CallOnFetchChannelsCanLoadMore", e.canLoadMore), this.trigger("CallOnFetchChannels", JSON.stringify(e.items.map(s)))
      })), this.gp.channels.on("error:fetchChannels", (e => this.trigger("CallOnFetchChannelsError"))), this.gp.channels.on("fetchMoreChannels", (e => {
        this.trigger("CallOnFetchMoreChannelsCanLoadMore", e.canLoadMore), this.trigger("CallOnFetchMoreChannels", JSON.stringify(e.items.map(s)))
        ...
        this.trigger("CallOnFetchInvitesCanLoadMore", e.canLoadMore), this.trigger("CallOnFetchInvites", JSON.stringify(e.items.map(r)))
      })), this.gp.channels.on("error:fetchInvites", (e => this.trigger("CallOnFetchInvitesError"))), this.gp.channels.on("fetchMoreInvites", (e => {
        this.trigger("CallOnFetchMoreInvitesCanLoadMore", e.canLoadMore), this.trigger("CallOnFetchMoreInvites", JSON.stringify(e.items.map(r)))
        ...
        this.trigger("CallOnFetchSentInvitesCanLoadMore", e.canLoadMore), this.trigger("CallOnFetchSentInvites", JSON.stringify(e.items.map(r)))
        ...
        this.trigger("CallOnFetchMoreSentInvitesCanLoadMore", e.canLoadMore), this.trigger("CallOnFetchMoreSentInvites", JSON.stringify(e.items.map(r)))
        ...
        this.trigger("CallOnFetchSentJoinRequestsCanLoadMore", e.canLoadMore), this.trigger("CallOnFetchSentJoinRequests", JSON.stringify(e.items.map(r)))
        ...
        this.trigger("CallOnFetchMoreSentJoinRequestsCanLoadMore", e.canLoadMore), this.trigger("CallOnFetchMoreSentJoinRequests", JSON.stringify(e.items.map(r)))
    ...
    CustomCall(e, t) {
      let s = "GamePush." + e;
      if (null == t) window.executeFunctionByName(s, window);
      else {
        let e = t.replace(/\s/g, "").split(",");
        window.executeFunctionByName(s, window, ...e)
      }
    }
    CustomReturn(e, s) {
      let r, n = "GamePush." + e;
      if (null == s) r = window.executeFunctionByName(n, window);
      else {
        let e = (s = s.replace(/\s/g, "")).split(",");
        r = window.executeFunctionByName(n, window, ...e)
      }
      return t(r)
    }
    CustomGetValue(e) {
      let s = "GamePush." + e;
      return t(window.returnValueByName(s, window))
    }
    CustomAsyncReturn(e, s) {
      let r = "GamePush." + e;
      null != s && (s = s.replace(/\s/g, "").split(","));
      try {
        window.executeFunctionByName(r, window, ...s).then((e => {
          this.trigger("CallCustomAsyncReturn", t(e))
        })).catch((e => {
          console.warn(e), this.trigger("CallCustomAsyncError", e)
        }))
      } catch (e) {
        console.warn(e)
      }
  ...
  window.executeFunctionByName = function(e, t) {
    ...
    for (var r = e.split("."), n = r.pop(), i = 0; i < r.length; i++) t = t[r[i]];
    try {
      var a = t[n].apply(t, s)
    } catch (e) {
    ...
    return a
  }, window.returnValueByName = function(e, t) {
    for (var s = e.split("."), r = s.pop(), n = 0; n < s.length; n++) t = t[s[n]];
    try {
      var i = t[r]
    } catch (e) {
