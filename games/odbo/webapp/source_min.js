...
Audio.allow = function() {
  Audio.allowed = true;
  for (let i = 0; i < Audio.postAllowed.length; i++) {
    Audio.postAllowed[i](Audio.ctx);
  }
  Audio.postAllowed = [];
...
var Storage = {};
Storage.VERSION = 1;
Storage.PATH_VERSION = 'com.martinmagni.oddbotout/version';
Storage.PREFIX = 'com.martinmagni.oddbotout/data/';
