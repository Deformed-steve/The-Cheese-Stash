const unityApp = {
  ...
  startLoading: function() {
    ...
    const config = {
      arguments: [],
      dataUrl: buildUrl + "/821c54e9bca83d42ade4a3be4bfa99be.data.unityweb",
      frameworkUrl: buildUrl + "/a21a6cf885168bad3f5053475471f795.framework.js.unityweb",
      codeUrl: buildUrl + "/487dc1f6a0175482191daada39f66846.wasm.unityweb",
      streamingAssetsUrl: "StreamingAssets",
      companyName: "liss48",
      productName: "Скорость за Клик: Обби Роблокс",
