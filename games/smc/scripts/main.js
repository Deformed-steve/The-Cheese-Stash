...
window.DOMHandler = class {
  ...
  Attach() {}
  PostToRuntime(e, t, i, n) {
    this._iRuntime.PostToRuntimeComponent(this._componentId, e, t, i, n)
  }
  PostToRuntimeAsync(e, t, i, n) {
    return this._iRuntime.PostToRuntimeComponentAsync(this._componentId, e, t, i, n)
  }
...
};
{
  ...
  window.DOMElementHandler = class extends self.DOMHandler {
    ...
    _OnCreate(t) {
      const i = t.elementId,
        n = this.CreateElement(i, t),
        r = new e(n);
      this._elementMap.set(i, r), n.style.boxSizing = "border-box", n.style.display = "none", r.SetVisibleFlag(t.isVisible);
      const s = this._GetFocusElement(n);
      s.addEventListener("focus", e => this._OnFocus(i)), s.addEventListener("blur", e => this._OnBlur(i));
      const o = t.htmlIndex;
      if (r.SetWantHTMLIndex(o), r.SetHTMLZIndex(t.htmlZIndex), this._autoAttach) {
        const e = this.GetRuntimeInterface().GetAvailableHTMLIndex(o);
        r.SetActualHTMLIndex(e), this.GetRuntimeInterface().GetHTMLWrapElement(e).appendChild(n)
      }
    }
    CreateElement(e, t) {
    ...
    _OnUpdatePosition(e) {
      ...
      const t = this._elementMap.get(e.elementId),
        i = t.GetElement(),
        n = this.GetRuntimeInterface();
      i.style.left = e.left + "px", i.style.top = e.top + "px", i.style.width = e.width + "px", i.style.height = e.height + "px";
      const r = e.fontSize;
      null !== r && (i.style.fontSize = r + "em");
      const s = e.htmlIndex;
      t.SetWantHTMLIndex(s);
      const o = n.GetAvailableHTMLIndex(s);
      o !== t.GetActualHTMLIndex() && (i.remove(), n.GetHTMLWrapElement(o).appendChild(i), t.SetActualHTMLIndex(o), n._UpdateHTMLElementsZOrder());
      const a = e.htmlZIndex;
      a !== t.GetHTMLZIndex() && (t.SetHTMLZIndex(a), n._UpdateHTMLElementsZOrder()), t.HadFirstUpdate() || (t.SetHadFirstUpdate(), t.GetVisibleFlag() && (i.style.display = ""))
    }
  ...
  const t = /(iphone|ipod|ipad|macos|macintosh|mac os x)/i.test(navigator.userAgent),
    ...
    n = /safari/i.test(navigator.userAgent) && !/(chrome|chromium|edg\/|OPR\/)/i.test(navigator.userAgent);
  let r = 0;
  ...
  function s(e) {
    ...
    return t.async = !1, t.type = "module", e.isStringSrc ? new Promise(i => {
      ...
      ++r, self[n] = i, t.textContent = e.str + `\n\nself["${n}"]();`, document.head.appendChild(t)
    }) : new Promise((i, n) => {
      t.onload = i, t.onerror = n, t.src = e, document.head.appendChild(t)
    })
  }
  async function o() {
  ...
  window.RuntimeInterface = class e {
    ...
    #T = "";
    constructor(e) {
      if (this.#e = e.useWorker, this.#n = e.scriptFolder, this.#T = e.exportType, "playable-ad-single-file" !== this.#T && "playable-ad-zip" !== this.#T && "instant-games" !== this.#T || (this.#e = !1), (n || "macos-wkwebview" === this.#T) && (this.#e = !1), "cordova" === this.#T && this.#e && i) {
        const e = /Chrome\/(\d+)/i.exec(navigator.userAgent);
        e && parseInt(e[1], 10) >= 90 || (this.#e = !1)
      }
      this.IsAnyWebView2Wrapper() ? self.chrome.webview.addEventListener("message", e => this.#E(e.data, e.additionalObjects)) : "macos-wkwebview" === this.#T ? self.C3WrapperOnMessage = e => this.#E(JSON.parse(e)) : "linux-cef" === this.#T && self.c3_linux_cef_set_message_callback(e => this.#E(JSON.parse(e))), this._localFileBlobs = null, this._localFileStrings = null, "html5" !== this.#T || window.isSecureContext || console.warn("[Construct] Warning: the browser indicates this is not a secure context. Some features may be unavailable. Use secure (HTTPS) hosting to ensure all features are available."), this.AddRuntimeComponentMessageHandler("canvas", "update-size", e => this.#C(e)), this.AddRuntimeComponentMessageHandler("canvas", "set-html-layer-count", e => this._OnSetHTMLLayerCount(e)), this.AddRuntimeComponentMessageHandler("canvas", "cleanup-html-layers", () => this.#A()), this.AddRuntimeComponentMessageHandler("canvas", "update-html-layer-dom-state", e => this.#P(e.layersDomState)), this.AddRuntimeComponentMessageHandler("runtime", "create-job-worker", e => this.#R(e)), this.AddRuntimeComponentMessageHandler("runtime", "send-wrapper-extension-message", e => this.#I(e)), this.AddRuntimeComponentMessageHandler("runtime", "send-raw-wrapper-extension-message", e => this.#O(e)), "cordova" === this.#T ? document.addEventListener("deviceready", () => this.#M(e)) : this.#M(e), this._skipAndroidVirtualKeyboardDetection = 0
    }
    Release() {
      this._CancelAnimationFrame(), this.#t && (this.#t.onmessage = null, this.#t = null), this.#r && (this.#r.terminate(), this.#r = null), this.#s && (this.#s.Release(), this.#s = null);
      for (const {
          canvas: e,
          htmlWrap: t
        }
        of this.#d) e.remove(), t.remove();
      this.#d.length = 0
    }
    GetMainCanvas() {
    ...
    GetHTMLWrapElement(e) {
      if (e < 0 || e >= this.#d.length) throw new RangeError("invalid canvas layer");
    ...
    IsiOSCordova() {
      return t && "cordova" === this.#T
    }
    IsiOSWebView() {
      const e = navigator.userAgent;
      return t && f(this.#T) || navigator.standalone || /crios\/|fxios\/|edgios\//i.test(e)
    }
    IsAndroid() {
      return i
    }
    ...
    IsWindowsWebView2() {
      return "windows-webview2" === this.#T || !!("preview" === this.#T && window.chrome && window.chrome.webview && window.chrome.webview.postMessage)
    }
    IsAnyWebView2Wrapper() {
      return this.IsWindowsWebView2() || "xbox-uwp-webview2" === this.#T
    }
    ...
    async #M(e) {
      if (this.#e && (await o() || (this.#e = !1)), "macos-wkwebview" === this.#T && this._SendWrapperMessage({
          type: "ready"
        }), this.IsAnyWebView2Wrapper() || "macos-wkwebview" === this.#T || "linux-cef" === this.#T) {
        this.#x();
        const e = await this.#L();
        this.#S = e.registeredComponentIds
      }
      if ("playable-ad-single-file" === this.#T && (this._localFileBlobs = self.c3_base64files, this._localFileStrings = {}, await this.#D()), e.runtimeBaseUrl) this.#i = e.runtimeBaseUrl;
      else {
        const e = location.origin;
        this.#i = ("null" === e ? "file:///" : e) + location.pathname;
        const t = this.#i.lastIndexOf("/"); - 1 !== t && (this.#i = this.#i.substr(0, t + 1))
      }
      const t = new MessageChannel;
      if (this.#t = t.port1, this.#t.onmessage = e => this._OnMessageFromRuntime(e.data), window.c3_addPortMessageHandler && window.c3_addPortMessageHandler(e => this.#B(e)), this.#_ = new self.JobSchedulerDOM(this), await this.#_.Init(), "object" == typeof window.StatusBar && window.StatusBar.hide(), "object" == typeof window.AndroidFullScreen) try {
      ...
      this.#e ? await this.#G(e, t.port2) : await this.#N(e, t.port2)
    }
    #F(t) {
      return {
        ...
        ife: !!self.ife,
        jobScheduler: this.#_.GetPortData(),
        supportedAudioFormats: l,
    ...
    async #G(e, t) {
      ...
      "preview" === this.#T ? (this.#r = new Worker("previewworker.js", {
        type: "module",
        name: "Runtime"
      }), await new Promise((e, t) => {
        const n = i => {
          this.#r.removeEventListener("message", n), i.data && "ok" === i.data.type ? e() : t()
        };
        this.#r.addEventListener("message", n), this.#r.postMessage({
          type: "construct-worker-init",
          import: new URL(i, this.#i).toString()
        })
      })) : this.#r = await this.CreateWorker(i, {
        type: "module",
        name: "Runtime"
      });
      ...
      s.className = "c3htmlwrap", s.setAttribute("interactive", ""), document.body.appendChild(s), this.#d.push({
        canvas: n,
        htmlWrap: s,
      ...
      }), window.c3canvas = n, self.C3_InsertHTMLPlaceholders && self.C3_InsertHTMLPlaceholders(), this.#r.postMessage(Object.assign(this.#F(e), {
        type: "init-runtime",
        isInWorker: !0,
        messagePort: t,
        canvas: r,
      ...
      }), [t, r, ...this.#_.GetPortTransferables()]), this.#o = d.map(e => new e(this)), this.#U(), this.#a._AddDefaultCanvasEventHandlers(n), this.#a._AddDefaultHTMLWrapEventHandlers(s), this.#a._EnableWindowResizeEvent(), self.c3_callFunction = (e, t) => this.#a._InvokeFunctionFromJS(e, t), "preview" === this.#T && (self.goToLastErrorScript = () => this.PostToRuntimeComponent("runtime", "go-to-last-error-script"))
    }
    async #N(e, t) {
      const i = document.createElement("canvas");
      i.style.display = "none", document.body.appendChild(i);
      const n = document.createElement("div");
      n.className = "c3htmlwrap", n.setAttribute("interactive", ""), document.body.appendChild(n), this.#d.push({
        canvas: i,
        htmlWrap: n,
        lastHtmlLayerDomState: {
          isVisible: !0,
      ...
      }), window.c3canvas = i, self.C3_InsertHTMLPlaceholders && self.C3_InsertHTMLPlaceholders(), this.#o = d.map(e => new e(this)), this.#U(), this.#a._AddDefaultCanvasEventHandlers(i), this.#a._AddDefaultHTMLWrapEventHandlers(n);
      const r = await Promise.all(e.runtimeScriptList.map(e => this.#H(e)));
      await Promise.all(r.map(e => s(e)));
      const o = e.projectMainScriptPath,
        a = e.javaScriptInEventsPath,
        l = e.typeScriptInEventsPath;
      if (o) try {
        if (await s(o), "preview" === this.#T && !globalThis.C3_ProjectMainScriptOK) throw new Error("main script did not run to completion")
      } catch (e) {
        this.#W(), console.error("Error loading project main script: ", e), alert(`Failed to load the project main script (${o}). Check all your JavaScript code has valid syntax, all imports are written correctly, and that an exception was not thrown running the script. Press F12 and check the console for error details.`)
      }
      if (a) try {
        if (await s(a), "preview" === this.#T && !globalThis.C3.JavaScriptInEvents) throw new Error("JavaScript in events did not run to completion")
      } catch (e) {
        this.#W(), console.error("Error loading JavaScript in events: ", e), alert("Failed to load JavaScript in events. Check all your JavaScript code has valid syntax, all imports are written correctly, and that an exception was not thrown running the 'Imports for events' script. Press F12 and check the console for error details.")
      }
      if (l) try {
        if (await s(l), "preview" === this.#T && !globalThis.C3.TypeScriptInEvents) throw new Error("TypeScript in events did not run to completion")
      } catch (e) {
        this.#W(), console.error("Error loading TypeScript in events: ", e), alert("Failed to load TypeScript in events. Check all your TypeScript code has valid syntax, all imports are written correctly, and that an exception was not thrown running the 'Imports for events' script. Press F12 and check the console for error details.")
      }
      const c = Object.assign(this.#F(e), {
        isInWorker: !1,
        messagePort: t,
        canvas: i,
    ...
    async #R(e) {
      const t = await this.#_._CreateJobWorker();
      return {
        outputPort: t,
        transferables: [t]
      }
    ...
    #C(e) {
      ...
      for (const {
        ...
        of this.#d) e.style.width = t, e.style.height = i, e.style.marginLeft = n, e.style.marginTop = r, s.style.width = t, s.style.height = i, s.style.marginLeft = n, s.style.marginTop = r, this.#l && (e.style.display = "", s.style.display = "");
      document.documentElement.style.setProperty("--construct-scale", e.displayScale), this.#l = !1
    }
    _OnSetHTMLLayerCount(e) {
      ...
      if (t < this.#d.length)
        for (; this.#d.length > t;) {
          ...
          for (let e = 0, i = t - this.#d.length; e < i; ++e) {
            ...
            t.classList.add("c3htmlwrap", "c3overlay"), t.setAttribute("interactive", ""), document.body.appendChild(t), e.style.width = r, e.style.height = s, e.style.marginLeft = o, e.style.marginTop = a, t.style.width = r, t.style.height = s, t.style.marginLeft = o, t.style.marginTop = a, this.#a._AddDefaultCanvasEventHandlers(e), this.#a._AddDefaultHTMLWrapEventHandlers(t), this.#d.push({
              canvas: e,
              htmlWrap: t,
              lastHtmlLayerDomState: {
                isVisible: !0,
      ...
      this.#P(i);
      for (const e of this.#o) e instanceof window.DOMElementHandler && e._OnHTMLLayersChanged();
    ...
    #P(e) {
      for (let t = 0, i = Math.min(this.#d.length, e.length); t < i; ++t) {
        const {
          htmlWrap: i,
          lastHtmlLayerDomState: n
        } = this.#d[t], r = e[t], s = r.isVisible, o = r.opacity, a = r.isInteractive;
        s !== n.isVisible && (i.style.display = s ? "" : "none", n.isVisible = s), o !== n.opacity && (i.style.opacity = 1 === o ? "" : String(o), n.opacity = o), a !== n.isInteractive && (i.style.pointerEvents = a ? "" : "none", a ? i.setAttribute("interactive", "") : i.removeAttribute("interactive"), n.isInteractive = a)
      }
    }
    #A() {
    ...
    _UpdateHTMLElementsZOrder() {
      this.#u || (this.#u = !0, this._AddRAFCallback(this.#h))
    }
    #p() {
      this._RemoveRAFCallback(this.#h), this.#u = !1;
      let e = [];
      for (const t of this.#o)
        ...
        return i !== n ? i - n : e.GetHTMLZIndex() - t.GetHTMLZIndex()
      });
      let t = 0,
        i = 0,
        n = 0,
      ...
      for (; n < r; ++n) {
        const r = e[n];
        r.GetActualHTMLIndex() !== t && (this.#z(t, e.slice(i, n)), t = r.GetActualHTMLIndex(), i = n)
      }
      i < n && this.#z(t, e.slice(i, n))
    }
    #z(e, t) {
      ...
      const i = t.map(e => e.GetElement()),
        ...
        s = Array.from(r.children).filter(e => n.has(e));
      for (let e = 0, t = 0, n = i.length; e < n; ++e) {
        const n = i[e],
          o = s[t];
        n === o ? ++t : r.moveBefore ? r.moveBefore(n, o) : r.insertBefore(n, o)
      }
    }
    _OnLocalRuntimeMessageFromDOM(e) {
      if (this.#e) throw new Error("not available in worker mode");
      this.#s._OnMessageFromDOM(e)
    }
    PostToRuntimeComponent(e, t, i, n, r) {
      this.#t.postMessage({
        type: "event",
        component: e,
        handler: t,
    ...
    PostToRuntimeComponentAsync(e, t, i, n, r) {
      const s = h++,
        o = new Promise((e, t) => {
          u.set(s, {
            resolve: e,
    ...
    _OnMessageFromRuntime(e) {
      const t = e.type;
      if ("event" === t) return this.#q(e);
      if ("result" === t) this.#j(e);
      else if ("runtime-ready" === t) this.#X();
      else if ("alert-error" === t) this.#W(), alert(e.message);
      else {
    ...
    #q(e) {
      const t = e.component,
        ...
        r = e.responseId,
        s = c.get(t);
      if (!s) return void console.warn(`[DOM] No event handlers for component '${t}'`);
      const o = s.get(i);
      ...
      try {
        ...
        return console.error(`Exception in '${t}' handler '${i}':`, e), void(null !== r && this.#Y(r, !1, "" + e))
      }
      if (null === r) return a;
      a && a.then ? a.then(e => this.#Y(r, !0, e)).catch(e => {
        console.error(`Rejection from '${t}' handler '${i}':`, e), this.#Y(r, !1, "" + e)
      }) : this.#Y(r, !0, a)
    }
    #Y(e, t, i) {
      let n;
      i && i.transferables && (n = i.transferables), this.#t.postMessage({
        type: "result",
        responseId: e,
        isOk: t,
        result: i
    ...
    #j(e) {
      const t = e.responseId,
        ...
        n = e.result,
        r = u.get(t);
      i ? r.resolve(n) : r.reject(n), u.delete(t)
    }
    AddRuntimeComponentMessageHandler(e, t, i) {
      let n = c.get(e);
      if (n || (n = new Map, c.set(e, n)), n.has(t)) throw new Error(`[DOM] Component '${e}' already has handler '${t}'`);
      n.set(t, i)
    }
    static AddDOMHandlerClass(e) {
      if (d.includes(e)) throw new Error("DOM handler already added");
      d.push(e)
    }
    #U() {
      for (const e of this.#o)
        if ("runtime" === e.GetComponentID()) return void(this.#a = e);
    ...
    #X() {
      for (const e of this.#o) e.Attach()
    }
    ...
    _AddRAFCallback(e) {
      this.#w.add(e), this._RequestAnimationFrame()
    }
    _RemoveRAFCallback(e) {
      this.#w.delete(e), 0 === this.#w.size && this._CancelAnimationFrame()
    }
    _RequestAnimationFrame() {
      -1 === this.#y && this.#w.size > 0 && (this.#y = requestAnimationFrame(this.#g))
    }
    ...
    #v() {
      this.#y = -1;
      for (const e of this.#w) e();
      this._RequestAnimationFrame()
    }
    TryPlayMedia(e) {
      this.#a.TryPlayMedia(e)
    }
    RemovePendingPlay(e) {
      this.#a.RemovePendingPlay(e)
    }
    _PlayPendingMedia() {
      this.#a._PlayPendingMedia()
    }
    AddAnyGamepadInputCallback(e) {
      this.#a._AddAnyGamepadInputCallback(e)
    }
    RemoveAnyGamepadInputCallback(e) {
      this.#a._RemoveAnyGamepadInputCallback(e)
    }
    SetSilent(e) {
      this.#a.SetSilent(e)
    }
    ...
    #J(e) {
      const t = this.#K();
      return new Promise((i, n) => t.checkPermission(this.#$(t, e), e => i(!!e.hasPermission), n))
    }
    #Z(e) {
      const t = this.#K();
      return new Promise((i, n) => t.requestPermission(this.#$(t, e), e => i(!!e.hasPermission), n))
    }
    async RequestPermissions(e) {
      if ("cordova" !== this.GetExportType()) return !0;
      if (this.IsiOSCordova()) return !0;
      for (const t of e)
        if (!await this.#J(t) && !1 === await this.#Z(t)) return !1;
      return !0
    }
    ...
    #E(t, i) {
      ...
      const n = t.type;
      if ("directory-handles" === n) this.#k = i;
      else if ("wrapper-init-response" === n) this.#b(t), this.#b = null;
      else if ("fullscreen-change" === n) e._SetWrapperIsFullscreenFlag(t.isFullscreen), this.#a._OnFullscreenChange();
      else if ("log-to-console" === n) switch (t.logType) {
        case "error":
      ...
      } else "extension-message" === n ? this.PostToRuntimeComponent("runtime", "wrapper-extension-message", t) : console.warn("Unknown wrapper message: ", t)
    }
    #I(e) {
    ...
    _SendWrapperMessage(e) {
      this.IsAnyWebView2Wrapper() ? window.chrome.webview.postMessage(JSON.stringify(e)) : "macos-wkwebview" === this.#T ? window.webkit.messageHandlers.C3Wrapper.postMessage(JSON.stringify(e)) : "linux-cef" === this.#T && window.c3_linux_cef_sendmessage(JSON.stringify(e))
    }
    #x() {
      window.moveTo = (e, t) => {
        this._SendWrapperMessage({
    ...
    #L() {
      return new Promise(e => {
        this.#b = e, this._SendWrapperMessage({
          type: "wrapper-init"
        })
      })
    }
    ...
    async #D() {
      const e = [];
      for (const [t, i] of Object.entries(this._localFileBlobs)) e.push(this.#Q(t, i));
      await Promise.all(e)
    }
    async #Q(e, t) {
      if ("object" == typeof t) this._localFileBlobs[e] = new Blob([t.str], {
        ...
        let i = await this.#ee(t);
        i || (i = this.#te(t)), this._localFileBlobs[e] = i
      }
    }
    async #ee(e) {
      try {
    ...
    #ie(e) {
      ...
      const i = e.substring(5, t),
        ...
        a = r[2];
      let l;
      return l = "base64" === o || "base64" === a ? atob(n) : decodeURIComponent(n), {
        mime_type: s,
        data: l
      }
    }
    #ne(e, t) {
      let i, n, r = e.length,
        s = r >> 2,
        o = new Uint8Array(r),
        a = new Uint32Array(o.buffer, 0, s);
      for (i = 0, n = 0; i < s; ++i) a[i] = e.charCodeAt(n++) | e.charCodeAt(n++) << 8 | e.charCodeAt(n++) << 16 | e.charCodeAt(n++) << 24;
      let l = 3 & r;
      for (; l--;) o[n] = e.charCodeAt(n), ++n;
      return new Blob([o], {
        type: t
      })
    }
  ...
  const C = new Set(["input", "textarea", "datalist", "select"]),
    A = new Set(["canvas", "body", "html"]);

  function P(e) {
    if (!e.target.tagName) return;
    const t = e.target.tagName.toLowerCase();
    A.has(t) && e.preventDefault()
  }
  ...
  }, self.C3_RasterSvgImageBlob = async function(e, t, i, n, r) {
    const s = await T(e),
      o = document.createElement("canvas");
    return o.width = n, o.height = r, o.getContext("2d").drawImage(s, 0, 0, t, i), o
  };
  let O = !1;
  ...
  const x = "runtime",
    L = class extends self.DOMHandler {
      ...
      _AddDefaultCanvasEventHandlers(e) {
        e.addEventListener("selectstart", P), e.addEventListener("gesturehold", P), e.addEventListener("pointerdown", P)
      }
      _AddDefaultHTMLWrapEventHandlers(e) {
        e.addEventListener("selectstart", R), e.addEventListener("gesturehold", R), e.addEventListener("touchstart", R), e.addEventListener("dragstart", R)
      }
      _OnBeforeStartTicking() {
        return self.setTimeout(() => {
          this._enableAndroidVKDetection = !0
        }, 1e3), "cordova" === this._iRuntime.GetExportType() ? (document.addEventListener("pause", () => this._OnVisibilityChange(!0)), document.addEventListener("resume", () => this._OnVisibilityChange(!1))) : document.addEventListener("visibilitychange", () => this._OnVisibilityChange("hidden" === document.visibilityState)), this._pageVisibilityIsHidden = !("hidden" !== document.visibilityState && !O), {
      ...
      Attach() {
        window.addEventListener("focus", () => this._PostRuntimeEvent("window-focus")), window.addEventListener("blur", () => {
          ...
          var t;
          t = e.target, (C.has(t.tagName.toLowerCase()) || E(t)) && this._PostRuntimeEvent("keyboard-blur")
      ...
      _OnAndroidVirtualKeyboardChange(e, t) {
        if (document.body.style.position = "", document.body.style.overflow = "", document.body.style.transform = "", this._vkTranslateYOffset = 0, t > 0) {
          ...
          if (i) {
            ...
            let r = (n.top + n.bottom) / 2 - (e - t) / 2;
            r > t && (r = t), r < 0 && (r = 0), r > 0 && (document.body.style.position = "absolute", document.body.style.overflow = "visible", document.body.style.transform = `translateY(${-r}px)`, this._vkTranslateYOffset = r)
          }
        }
      }
      _PostRuntimeEvent(e, t) {
        this.PostToRuntime(e, t || null, k)
      }
      _GetWindowInnerWidth() {
      ...
      _OnWindowResize() {
        ...
        this.PostToRuntime("window-resize", {
          ...
          innerHeight: t,
          devicePixelRatio: window.devicePixelRatio,
          isFullscreen: y.IsDocumentFullscreen(),
      ...
      _OnSimulatedResize(e, t, i) {
        const n = this._GetWindowInnerWidth(),
          r = this._GetWindowInnerHeight();
        this._simulatedResizeTimerId = -1, n != e || r != t ? this.PostToRuntime("window-resize", {
          innerWidth: n,
          innerHeight: r,
          devicePixelRatio: window.devicePixelRatio,
          isFullscreen: y.IsDocumentFullscreen(),
          cssDisplayMode: this._iRuntime.GetCssDisplayMode()
        }) : i < 10 && this._ScheduleSimulatedResize(n, r, i + 1)
      }
      ...
      _OnFullscreenChange() {
        if (this._isExportToVideo) return;
        const e = y.IsDocumentFullscreen();
      ...
      _OnKeyEvent(e, t) {
        ...
        if ("Backspace" === t.key && P(t), this._isExportToVideo) return;
        const i = w.get(t.code) || t.code;
      ...
      _OnMouseEvent(e, t, i) {
        this._isExportToVideo || v(t) || this._PostToRuntimeMaybeSync(e, {
          button: t.button,
          buttons: t.buttons,
          clientX: t.clientX,
          clientY: t.clientY + this._vkTranslateYOffset,
      ...
      _OnPointerEvent(e, t) {
        ...
        "mouse" === t.pointerType && (i = this._mousePointerLastButtons), this._PostToRuntimeMaybeSync(e, {
          ...
          twist: t.twist || 0,
          timeStamp: t.timeStamp
        }, b), "mouse" === t.pointerType && (this._mousePointerLastButtons = t.buttons)
      }
      ...
      _OnDeviceMotion(e) {
        ...
        let n = null;
        const r = e.accelerationIncludingGravity;
        r && (n = {
          x: r.x || 0,
          y: r.y || 0,
          z: r.z || 0
      ...
      _OnInvokeDownload(e) {
        const t = e.url,
          ...
          r = document.body;
        n.textContent = i, n.href = t, n.download = i, r.appendChild(n), n.click(), r.removeChild(n)
      }
      ...
      async _OnRasterSvgImage(e) {
        const t = e.blob,
          ...
          s = e.surfaceHeight,
          o = e.imageBitmapOpts,
          a = await self.C3_RasterSvgImageBlob(t, i, n, r, s);
        let l;
        return l = o ? await createImageBitmap(a, o) : await createImageBitmap(a), {
          imageBitmap: l,
          transferables: [l]
        }
      }
      ...
      _OnGamepadConnected() {
        this._isPollingGamepads || (this._iRuntime._AddRAFCallback(this._pollGamepadRafCallback), this._isPollingGamepads = !0, this._OnAnyGamepadInput())
      }
      _OnGamepadDisconnected() {
        this._isPollingGamepads && navigator.getGamepads().every(e => !e) && (this._iRuntime._RemoveRAFCallback(this._pollGamepadRafCallback), this._isPollingGamepads = !1)
      }
      _OnPollGamepads() {
  ...
  self.JobSchedulerDOM = class {
    ...
    async Init() {
      ...
      const e = this._runtimeInterface.GetScriptFolder() + D;
    ...
    async _CreateJobWorker() {
      const e = this._jobWorkers.length,
        t = this._runtimeInterface.GetScriptFolder() + B,
      ...
      return this._dispatchWorker.postMessage({
        type: "_addJobWorker",
        port: n.port1
      }, [n.port1]), i.postMessage({
        type: "init",
        number: e,
        "dispatch-port": n.port2,
        "output-port": r.port2
      }, [n.port2, r.port2]), this._jobWorkers.push(i), r.port1
    }
    GetPortData() {
      return {
  ...
  function U() {}
  window.addEventListener("beforeinstallprompt", e => (e.preventDefault(), G = e, N && N._OnBeforeInstallPrompt(), !1));
  const H = "browser",
    W = class extends self.DOMHandler {
      constructor(e) {
        super(e, H), this._exportType = "", this.AddRuntimeMessageHandlers([
        ...
        ]), window.addEventListener("online", () => this._OnOnlineStateChanged(!0)), window.addEventListener("offline", () => this._OnOnlineStateChanged(!1)), window.addEventListener("hashchange", () => this._OnHashChange()), window.addEventListener("fullscreenerror", () => this._OnFullscreenError()), window.addEventListener("webkitfullscreenerror", () => this._OnFullscreenError()), window.addEventListener("mozfullscreenerror", () => this._OnFullscreenError()), this._beforeunload_handler = e => e.preventDefault(), document.addEventListener("backbutton", () => this._OnCordovaBackButton())
      }
      Attach() {
        G ? this._OnBeforeInstallPrompt() : N = this, window.addEventListener("appinstalled", () => this._OnAppInstalled())
      }
      ...
      async _OnRequestInstall() {
        ...
        try {
          return G.prompt(), {
            result: (await G.userChoice).outcome
          }
        } catch (e) {
      ...
      _OnNavigate(e) {
        ...
        if ("back" === t) navigator.app && navigator.app.backHistory ? navigator.app.backHistory() : window.history.back();
          ...
          const t = e.url,
            i = e.target,
            n = e.exportType;
          self.cordova && self.cordova.InAppBrowser ? self.cordova.InAppBrowser.open(t, "_system") : "preview" === n || "macos-wkwebiew" === n || "linux-cef" === n || this._iRuntime.IsAnyWebView2Wrapper() ? window.open(t, "_blank") : this._isConstructArcade || (2 === i ? window.top.location = t : 1 === i ? window.parent.location = t : window.location = t)
      ...
      _OnRequestFullscreen(e) {
        if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType) self.RuntimeInterface._SetWrapperIsFullscreenFlag(!0), this._iRuntime._SendWrapperMessage({
          ...
          let r;
          n.requestFullscreen ? r = n.requestFullscreen(t) : n.mozRequestFullScreen ? r = n.mozRequestFullScreen(t) : n.msRequestFullscreen ? r = n.msRequestFullscreen(t) : n.webkitRequestFullScreen && (r = void 0 !== Element.ALLOW_KEYBOARD_INPUT ? n.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT) : n.webkitRequestFullScreen()), r instanceof Promise && r.catch(U)
        }
      }
      _OnFullscreenError() {
      ...
      _OnExitFullscreen() {
        if (this._iRuntime.IsAnyWebView2Wrapper() || "macos-wkwebview" === this._exportType || "linux-cef" === this._exportType) self.RuntimeInterface._SetWrapperIsFullscreenFlag(!1), this._iRuntime._SendWrapperMessage({
          ...
          let e;
          document.exitFullscreen ? e = document.exitFullscreen() : document.mozCancelFullScreen ? e = document.mozCancelFullScreen() : document.msExitFullscreen ? e = document.msExitFullscreen() : document.webkitCancelFullScreen && (e = document.webkitCancelFullScreen()), e instanceof Promise && e.catch(U)
        }
      }
      _OnSetHash(e) {
      ...
      _OnSetDocumentCSSStyle(e) {
        ...
        try {
          const e = F(n, r);
          for (const n of e) t.startsWith("--") ? n.style.setProperty(t, i) : n.style[t] = i
        } catch (e) {
  ...
  const V = "touch",
    z = class extends self.DOMHandler {
      constructor(e) {
        super(e, V), this.AddRuntimeMessageHandler("request-permission", e => this._OnRequestPermission(e))
      }
  ...
  const q = "mouse",
    j = class extends self.DOMHandler {
      constructor(e) {
        super(e, q), this.AddRuntimeMessageHandlers([
  ...
  const X = "keyboard",
    Y = class extends self.DOMHandler {
      constructor(e) {
        super(e, X), this._isKeyboardLockSupported = !(!navigator.keyboard || !navigator.keyboard.lock), this.AddRuntimeMessageHandlers([
          ["init", () => this._OnInit()],
  ...
  self.RuntimeInterface.AddDOMHandlerClass(Y)
} {
  const K = "gamepad";
  let $ = !1;
  const J = class extends self.DOMHandler {
    constructor(e) {
      super(e, K), this._isReady = !1, this._timerId = -1, this.AddRuntimeMessageHandler("ready", () => this._OnReady()), this.AddRuntimeMessageHandler("vibrate-dual-rumble", e => this._OnGamepadVibrateDualRumble(e)), this.AddRuntimeMessageHandler("vibrate-trigger-rumble", e => this._OnGamepadVibrateTriggerRumble(e)), this.AddRuntimeMessageHandler("reset-vibrate", e => this._OnGamepadResetVibrate(e)), this.AddRuntimeMessageHandler("suspend", () => this._OnSuspend()), this.AddRuntimeMessageHandler("resume", () => this._OnResume()), window.addEventListener("gamepadconnected", e => this._OnGamepadConnected(e)), window.addEventListener("gamepaddisconnected", e => this._OnGamepadDisconnected(e)), window.addEventListener("unload", () => this._OnWindowUnload())
    }
    _GetActiveGamepads() {
      try {
        return Array.from(navigator.getGamepads()).filter(e => e && e.connected)
      } catch (e) {
        return $ || (console.warn("[Construct] Failed to access gamepads: ", e), $ = !0), []
      }
    }
    _OnReady() {
      this._isReady = !0;
      for (const e of this._GetActiveGamepads()) this._PostGamepadConnectedEvent(e);
    ...
    _StopGamepadPollTimer() {
      -1 !== this._timerId && (clearInterval(this._timerId), this._timerId = -1)
    }
    _OnSuspend() {
  ...
  const Z = "localstorage",
    Q = class extends self.DOMHandler {
      constructor(e) {
        super(e, Z), this.AddRuntimeMessageHandlers([
          ["init", () => this._Init()],
  ...
  self.AudioDOMHandler = class extends self.DOMHandler {
    ...
    _AttachUnblockEvents() {
      this._hasAttachedUnblockEvents || (window.addEventListener("pointerup", this._unblockFunc, !0), window.addEventListener("touchend", this._unblockFunc, !0), window.addEventListener("click", this._unblockFunc, !0), window.addEventListener("keydown", this._unblockFunc, !0), this._iRuntime.AddAnyGamepadInputCallback(this._unblockFunc), this._iRuntime.IsiOSWebView() || document.addEventListener("visibilitychange", this._unblockFunc), this._hasAttachedUnblockEvents = !0)
    }
    _DetachUnblockEvents() {
      this._hasAttachedUnblockEvents && (window.removeEventListener("pointerup", this._unblockFunc, !0), window.removeEventListener("touchend", this._unblockFunc, !0), window.removeEventListener("click", this._unblockFunc, !0), window.removeEventListener("keydown", this._unblockFunc, !0), this._iRuntime.RemoveAnyGamepadInputCallback(this._unblockFunc), this._iRuntime.IsiOSWebView() || document.removeEventListener("visibilitychange", this._unblockFunc), this._hasAttachedUnblockEvents = !1)
    }
    ...
    _MatchTagLists(e, t) {
      for (const i of t) {
        let t = !1;
        for (const n of e)
          if (self.AudioDOMHandler.EqualsNoCase(n, i)) {
            t = !0;
            break
          } if (!t) return !1
      }
    ...
    _ReconnectEffects(e) {
      ...
      if (i && i.length) {
        ...
        for (let e = 0, t = i.length; e < t; ++e) {
          const n = i[e];
          e + 1 === t ? n.ConnectTo(this.GetDestinationNode()) : n.ConnectTo(i[e + 1].GetInputNode())
        }
      }
    ...
    ReleaseInstancesForBuffer(e) {
      let t = 0;
      for (let i = 0, n = this._audioInstances.length; i < n; ++i) {
        const n = this._audioInstances[i];
    ...
    async _GetAudioBuffer(e, t, i, n, r) {
      for (const e of this._audioBuffers)
        if (e.GetUrl() === t) return n && this._playMusicAsSound && (this._lastMusicBuffer = e), await e.Load(), e;
      if (r) return null;
      n && this._playMusicAsSound && this.ReleaseAllMusicBuffersExceptLast();
      const s = self.C3AudioBuffer.Create(this, e, t, i, n);
      return this._audioBuffers.push(s), n && this._playMusicAsSound && (this._lastMusicBuffer = s), await s.Load(), this._loadedAudioUrls.has(e) || (this.PostToRuntime("buffer-metadata", {
        originalUrl: e,
        duration: s.GetDuration()
      }), this._loadedAudioUrls.add(e)), s
    }
    async _GetAudioInstance(e, t, i, n, r) {
      for (const e of this._audioInstances)
        if (e.GetUrl() === t && (e.CanBeRecycled() || r)) return r && this._playMusicAsSound && (this._lastMusicBuffer = e.GetBuffer()), e.SetTags(n), e;
      const s = await this._GetAudioBuffer(e, t, i, r);
      if (s.WasReleased()) throw new Error(`buffer '${e}' unloaded while loading`);
      const o = s.CreateInstance(n);
    ...
    async _Play(e) {
      const t = e.originalUrl,
        ...
        c = e.stereoPan;
      let u = e.off;
      u > 0 && !e.trueClock && (u += this.GetAudioCurrentTime()), this._lastPlayedTags = s.slice(0), this._AddPendingTags(s);
      try {
        this._lastAudioInstance = await this._GetAudioInstance(t, i, n, s, r), d ? (this._lastAudioInstance.SetPannerEnabled(!0), this._lastAudioInstance.SetPan(d.x, d.y, d.z, d.angle, d.innerAngle, d.outerAngle, d.outerGain), d.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(d.uid)) : "number" == typeof c && 0 !== c ? (this._lastAudioInstance.SetStereoPannerEnabled(!0), this._lastAudioInstance.SetStereoPan(c)) : (this._lastAudioInstance.SetPannerEnabled(!1), this._lastAudioInstance.SetStereoPannerEnabled(!1)), this._lastAudioInstance.Play(o, a, l, u)
      } catch (e) {
        return void console.error("[Construct] Audio: error starting playback: ", e)
      } finally {
        this._RemovePendingTags(s)
      }
      this._StartTicking()
    }
    _Stop(e) {
    ...
    async _FadeVolume(e) {
      ...
      for (const e of this.audioInstancesMatchingTags(t)) e.FadeVolume(i, n, r);
      this._MaybeStartTicking()
    }
    _SetMasterVolume(e) {
    ...
    async _Preload(e) {
      const t = e.originalUrl,
        ...
        r = e.isMusic;
      try {
        await this._GetAudioInstance(t, i, n, "", r)
      } catch (e) {
    ...
    async _Unload(e) {
      const t = e.url,
        i = e.type,
        n = e.isMusic,
        r = await this._GetAudioBuffer("", t, i, n, !0);
      if (!r) return;
      r.Release(), this._lastMusicBuffer === r && (this._lastMusicBuffer = null);
      const s = this._audioBuffers.indexOf(r); - 1 !== s && this._audioBuffers.splice(s, 1)
    }
    _UnloadAll() {
    ...
    async _AddEffect(e) {
      ...
      if ("convolution" === t) try {
        s = await this._GetAudioBuffer(e.bufferOriginalUrl, e.bufferUrl, e.bufferType, !1)
      } catch (e) {
        return void console.log("[Construct] Audio: error loading convolution: ", e)
      }
      for (const o of i) {
        if ("filter" === t) r = new self.C3AudioFilterFX(this, ...n);
        else if ("delay" === t) r = new self.C3AudioDelayFX(this, ...n);
        else if ("convolution" === t) r = new self.C3AudioConvolveFX(this, s.GetAudioBuffer(), ...n), r._SetBufferInfo(e.bufferOriginalUrl, e.bufferUrl, e.bufferType);
        else if ("flanger" === t) r = new self.C3AudioFlangerFX(this, ...n);
        else if ("phaser" === t) r = new self.C3AudioPhaserFX(this, ...n);
        else if ("gain" === t) r = new self.C3AudioGainFX(this, ...n);
        else if ("stereopan" === t) r = new self.C3AudioStereoPanFX(this, ...n);
        else if ("tremolo" === t) r = new self.C3AudioTremoloFX(this, ...n);
        else if ("ringmod" === t) r = new self.C3AudioRingModFX(this, ...n);
        else if ("distortion" === t) r = new self.C3AudioDistortionFX(this, ...n);
        else if ("compressor" === t) r = new self.C3AudioCompressorFX(this, ...n);
        else {
          if ("analyser" !== t) throw new Error("invalid effect type");
          r = new self.C3AudioAnalyserFX(this, ...n)
        }
        this.AddEffectForTag(o, r)
      }
    ...
    _SetEffectParam(e) {
      ...
      for (const e of t) {
        const t = this._effects.get(e.toLowerCase());
        !t || i < 0 || i >= t.length || t[i].SetParam(n, r, s, o)
      }
      this._PostUpdatedFxState()
    }
    _RemoveEffects(e) {
    ...
    async _OnLoadState(e) {
      ...
      const n = e.listenerOrientation;
      if (Array.isArray(n)) {
        for (let e = 0; e < 6; ++e) this._lastListenerOrientation[e] = n[e];
        this._audioContext.listener.setOrientation(...this._lastListenerOrientation)
      }
      ...
      const r = [];
      for (const t of Object.values(e.effects)) r.push(Promise.all(t.map(e => this._AddEffect(e))));
      await Promise.all(r), await Promise.all(e.playing.map(e => this._LoadAudioInstance(e, t))), this._MaybeStartTicking()
    }
    async _LoadAudioInstance(e, t) {
      ...
      let c = null;
      try {
        c = await this._GetAudioInstance(i, n, r, o, s)
      } catch (e) {
        return void console.error("[Construct] Audio: error loading audio state: ", e)
      }
      c.LoadPanState(e.pan), c.LoadStereoPanState(e.stereoPan), c.Play(a, l, d, 0), e.isPlaying || c.Pause(), c._LoadAdditionalState(e)
    }
    ...
    _OnOfflineRenderCompleted(e) {
      const t = [];
      for (let i = 0, n = e.numberOfChannels; i < n; ++i) {
        const n = e.getChannelData(i);
        t.push(n.buffer)
      }
...
self.C3AudioBuffer = class {
  constructor(e, t, i, n, r) {
    this._audioDomHandler = e, this._originalUrl = t, this._url = i, this._type = n, this._isMusic = r, this._api = "", this._loadState = "not-loaded", this._loadPromise = null
  }
  Release() {
  ...
  static Create(e, t, i, n, r) {
    return !r || e.IsPlayMusicAsSound() ? new self.C3WebAudioBuffer(e, t, i, n, r) : new self.C3Html5AudioBuffer(e, t, i, n, r)
  }
  CreateInstance(e) {
  ...
  constructor(e, t, i, n, r) {
    super(e, t, i, n, r), this._api = "webaudio", this._audioData = null, this._audioBuffer = null
  }
  Release() {
...
};
{
  ...
  self.C3AudioInstance = class {
    ...
    FadeVolume(e, t, i) {
      ...
      const n = this._gainNode.gain;
      n.cancelScheduledValues(0);
      const r = this._audioDomHandler.GetAudioCurrentTime(),
        s = r + t;
      n.setValueAtTime(n.value, r), n.linearRampToValueAtTime(e, s), this._volume = e, this._fadeEndTime = s, this._stopOnFadeEnd = i
    }
    _UpdateVolume() {
    ...
    SetPan(e, t, i, n, r, s, o) {
      if (!this._isPannerEnabled) return;
      this.SetPanXYZA(e, t, i, n);
      const a = self.AudioDOMHandler.ToDegrees;
      this._pannerConeParams[0] !== a(r) && (this._pannerConeParams[0] = a(r), this._pannerNode.coneInnerAngle = a(r)), this._pannerConeParams[1] !== a(s) && (this._pannerConeParams[1] = a(s), this._pannerNode.coneOuterAngle = a(s)), this._pannerConeParams[2] !== o && (this._pannerConeParams[2] = o, this._pannerNode.coneOuterGain = o)
    }
    SetPanXYZA(e, t, i, n) {
      if (!this._isPannerEnabled) return;
      const r = this._pannerPosition,
        s = this._pannerOrientation,
        o = Math.cos(n),
        a = Math.sin(n);
      r[0] === e && r[1] === t && r[2] === i || (r[0] = e, r[1] = t, r[2] = i, this._pannerNode.setPosition(...r)), s[0] === o && s[1] === a && 0 === s[2] || (s[0] = o, s[1] = a, s[2] = 0, this._pannerNode.setOrientation(...s))
    }
...
self.C3Html5AudioInstance = class extends self.C3AudioInstance {
  ...
  Play(e, t, i, n) {
    const r = this.GetAudioElement();
    if (1 !== r.playbackRate && (r.playbackRate = 1), r.loop !== e && (r.loop = e), this.SetVolume(t), this._isMuted = !1, r.muted && (r.muted = !1), r.currentTime !== i) try {
      r.currentTime = i
    } catch (e) {
      console.warn(`[Construct] Exception seeking audio '${this._buffer.GetUrl()}' to position '${i}': `, e)
    }
    this._audioDomHandler.TryPlayMedia(r), this._isStopped = !1, this._isPaused = !1, this._isLooping = e, this._playbackRate = 1
  }
  Stop() {
  ...
  Play(e, t, i, n) {
    this._isMuted = !1, this._muteVol = 1, this.SetVolume(t), this._ReleaseBufferSource(), this._bufferSource = this.GetAudioContext().createBufferSource(), this._bufferSource.buffer = this._buffer.GetAudioBuffer(), this._bufferSource.connect(this._gainNode), this._activeSource = this._bufferSource, this._bufferSource.onended = this._onended_handler, this._bufferSource.loop = e, this._bufferSource.start(n, i), this._hasPlaybackEnded = !1, this._isStopped = !1, this._isPaused = !1, this._isLooping = e, this._playbackRate = 1, this._playStartTime = this.GetCurrentTime(), this._playFromSeekPos = i
  }
  Stop() {
...
};
{
  class ne {
    ...
    GetInputNode() {}
    ConnectTo(e) {}
    SetAudioParam(e, t, i, n) {
      if (e.cancelScheduledValues(0), 0 === n) return void(e.value = t);
      const r = this._audioContext.currentTime;
      switch (n += r, i) {
        case 0:
          e.setValueAtTime(t, n);
          break;
        case 1:
          e.setValueAtTime(e.value, r), e.linearRampToValueAtTime(t, n);
          break;
        case 2:
          e.setValueAtTime(e.value, r), e.exponentialRampToValueAtTime(t, n)
      }
    }
    GetState() {
      return {
  ...
  self.C3AudioFilterFX = class extends ne {
    constructor(e, t, i, n, r, s, o) {
      super(e), this._type = "filter", this._params = [t, i, n, r, s, o], this._inputNode = this.CreateGain(), this._wetNode = this.CreateGain(), this._wetNode.gain.value = o, this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - o, this._filterNode = this._audioContext.createBiquadFilter(), this._filterNode.type = t, this._filterNode.frequency.value = i, this._filterNode.detune.value = n, this._filterNode.Q.value = r, this._filterNode.gain.vlaue = s, this._inputNode.connect(this._filterNode), this._inputNode.connect(this._dryNode), this._filterNode.connect(this._wetNode)
    }
    Release() {
    ...
    SetParam(e, t, i, n) {
      switch (e) {
        case 0:
          t = Math.max(Math.min(t / 100, 1), 0), this._params[5] = t, this.SetAudioParam(this._wetNode.gain, t, i, n), this.SetAudioParam(this._dryNode.gain, 1 - t, i, n);
          break;
        case 1:
          this._params[1] = t, this.SetAudioParam(this._filterNode.frequency, t, i, n);
          break;
        case 2:
          this._params[2] = t, this.SetAudioParam(this._filterNode.detune, t, i, n);
          break;
        case 3:
          this._params[3] = t, this.SetAudioParam(this._filterNode.Q, t, i, n);
          break;
        case 4:
          this._params[4] = t, this.SetAudioParam(this._filterNode.gain, t, i, n)
      }
    }
  }, self.C3AudioDelayFX = class extends ne {
    constructor(e, t, i, n) {
      super(e), this._type = "delay", this._params = [t, i, n], this._inputNode = this.CreateGain(), this._wetNode = this.CreateGain(), this._wetNode.gain.value = n, this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - n, this._mainNode = this.CreateGain(), this._delayNode = this._audioContext.createDelay(t), this._delayNode.delayTime.value = t, this._delayGainNode = this.CreateGain(), this._delayGainNode.gain.value = i, this._inputNode.connect(this._mainNode), this._inputNode.connect(this._dryNode), this._mainNode.connect(this._wetNode), this._mainNode.connect(this._delayNode), this._delayNode.connect(this._delayGainNode), this._delayGainNode.connect(this._mainNode)
    }
    Release() {
    ...
    SetParam(e, t, i, n) {
      const r = self.AudioDOMHandler.DbToLinear;
      switch (e) {
        case 0:
          t = Math.max(Math.min(t / 100, 1), 0), this._params[2] = t, this.SetAudioParam(this._wetNode.gain, t, i, n), this.SetAudioParam(this._dryNode.gain, 1 - t, i, n);
          break;
        case 4:
          this._params[1] = r(t), this.SetAudioParam(this._delayGainNode.gain, r(t), i, n);
          break;
        case 5:
          this._params[0] = t, this.SetAudioParam(this._delayNode.delayTime, t, i, n)
      }
    }
  }, self.C3AudioConvolveFX = class extends ne {
    constructor(e, t, i, n) {
      super(e), this._type = "convolution", this._params = [i, n], this._bufferOriginalUrl = "", this._bufferUrl = "", this._bufferType = "", this._inputNode = this.CreateGain(), this._wetNode = this.CreateGain(), this._wetNode.gain.value = n, this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - n, this._convolveNode = this._audioContext.createConvolver(), this._convolveNode.normalize = i, this._convolveNode.buffer = t, this._inputNode.connect(this._convolveNode), this._inputNode.connect(this._dryNode), this._convolveNode.connect(this._wetNode)
    }
    Release() {
    ...
    SetParam(e, t, i, n) {
      0 === e && (t = Math.max(Math.min(t / 100, 1), 0), this._params[1] = t, this.SetAudioParam(this._wetNode.gain, t, i, n), this.SetAudioParam(this._dryNode.gain, 1 - t, i, n))
    }
    ...
    constructor(e, t, i, n, r, s) {
      super(e), this._type = "flanger", this._params = [t, i, n, r, s], this._inputNode = this.CreateGain(), this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - s / 2, this._wetNode = this.CreateGain(), this._wetNode.gain.value = s / 2, this._feedbackNode = this.CreateGain(), this._feedbackNode.gain.value = r, this._delayNode = this._audioContext.createDelay(t + i), this._delayNode.delayTime.value = t, this._oscNode = this._audioContext.createOscillator(), this._oscNode.frequency.value = n, this._oscGainNode = this.CreateGain(), this._oscGainNode.gain.value = i, this._inputNode.connect(this._delayNode), this._inputNode.connect(this._dryNode), this._delayNode.connect(this._wetNode), this._delayNode.connect(this._feedbackNode), this._feedbackNode.connect(this._delayNode), this._oscNode.connect(this._oscGainNode), this._oscGainNode.connect(this._delayNode.delayTime), this._oscNode.start(0)
    }
    Release() {
    ...
    SetParam(e, t, i, n) {
      switch (e) {
        case 0:
          t = Math.max(Math.min(t / 100, 1), 0), this._params[4] = t, this.SetAudioParam(this._wetNode.gain, t / 2, i, n), this.SetAudioParam(this._dryNode.gain, 1 - t / 2, i, n);
          break;
        case 6:
          this._params[1] = t / 1e3, this.SetAudioParam(this._oscGainNode.gain, t / 1e3, i, n);
          break;
        case 7:
          this._params[2] = t, this.SetAudioParam(this._oscNode.frequency, t, i, n);
          break;
        case 8:
          this._params[3] = t / 100, this.SetAudioParam(this._feedbackNode.gain, t / 100, i, n)
      }
    }
  }, self.C3AudioPhaserFX = class extends ne {
    constructor(e, t, i, n, r, s, o) {
      super(e), this._type = "phaser", this._params = [t, i, n, r, s, o], this._inputNode = this.CreateGain(), this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - o / 2, this._wetNode = this.CreateGain(), this._wetNode.gain.value = o / 2, this._filterNode = this._audioContext.createBiquadFilter(), this._filterNode.type = "allpass", this._filterNode.frequency.value = t, this._filterNode.detune.value = i, this._filterNode.Q.value = n, this._oscNode = this._audioContext.createOscillator(), this._oscNode.frequency.value = s, this._oscGainNode = this.CreateGain(), this._oscGainNode.gain.value = r, this._inputNode.connect(this._filterNode), this._inputNode.connect(this._dryNode), this._filterNode.connect(this._wetNode), this._oscNode.connect(this._oscGainNode), this._oscGainNode.connect(this._filterNode.frequency), this._oscNode.start(0)
    }
    Release() {
    ...
    SetParam(e, t, i, n) {
      switch (e) {
        case 0:
          t = Math.max(Math.min(t / 100, 1), 0), this._params[5] = t, this.SetAudioParam(this._wetNode.gain, t / 2, i, n), this.SetAudioParam(this._dryNode.gain, 1 - t / 2, i, n);
          break;
        case 1:
          this._params[0] = t, this.SetAudioParam(this._filterNode.frequency, t, i, n);
          break;
        case 2:
          this._params[1] = t, this.SetAudioParam(this._filterNode.detune, t, i, n);
          break;
        case 3:
          this._params[2] = t, this.SetAudioParam(this._filterNode.Q, t, i, n);
          break;
        case 6:
          this._params[3] = t, this.SetAudioParam(this._oscGainNode.gain, t, i, n);
          break;
        case 7:
          this._params[4] = t, this.SetAudioParam(this._oscNode.frequency, t, i, n)
      }
    }
    ...
    SetParam(e, t, i, n) {
      const r = self.AudioDOMHandler.DbToLinear;
      4 === e && (this._params[0] = r(t), this.SetAudioParam(this._node.gain, r(t), i, n))
    }
    ...
    SetParam(e, t, i, n) {
      t = Math.min(Math.max(t / 100, -1), 1), 9 === e && (this._params[0] = t, this.SetAudioParam(this._node.pan, t, i, n))
    }
    ...
    SetParam(e, t, i, n) {
      switch (e) {
        case 0:
          t = Math.max(Math.min(t / 100, 1), 0), this._params[1] = t, this.SetAudioParam(this._node.gain, 1 - t / 2, i, n), this.SetAudioParam(this._oscGainNode.gain, t / 2, i, n);
          break;
        case 7:
          this._params[0] = t, this.SetAudioParam(this._oscNode.frequency, t, i, n)
      }
    }
    ...
    SetParam(e, t, i, n) {
      switch (e) {
        case 0:
          t = Math.max(Math.min(t / 100, 1), 0), this._params[1] = t, this.SetAudioParam(this._wetNode.gain, t, i, n), this.SetAudioParam(this._dryNode.gain, 1 - t, i, n);
          break;
        case 7:
          this._params[0] = t, this.SetAudioParam(this._oscNode.frequency, t, i, n)
      }
    ...
    constructor(e, t, i, n, r, s) {
      super(e), this._type = "distortion", this._params = [t, i, n, r, s], this._inputNode = this.CreateGain(), this._preGain = this.CreateGain(), this._postGain = this.CreateGain(), this._SetDrive(n, r), this._wetNode = this.CreateGain(), this._wetNode.gain.value = s, this._dryNode = this.CreateGain(), this._dryNode.gain.value = 1 - s, this._waveShaper = this._audioContext.createWaveShaper(), this._curve = new Float32Array(65536), this._GenerateColortouchCurve(t, i), this._waveShaper.curve = this._curve, this._inputNode.connect(this._preGain), this._inputNode.connect(this._dryNode), this._preGain.connect(this._waveShaper), this._waveShaper.connect(this._postGain), this._postGain.connect(this._wetNode)
    }
    Release() {
    ...
    _GenerateColortouchCurve(e, t) {
      ...
      for (let n = 0; n < i; ++n) {
        let r = n / i;
        r = this._Shape(r, e, t), this._curve[i + n] = r, this._curve[i - n - 1] = -r
      }
    }
    _Shape(e, t, i) {
      const n = 1.05 * i * t - t,
        r = e < 0 ? -1 : 1,
        s = e < 0 ? -e : e;
      let o = s < t ? s : t + n * self.AudioDOMHandler.e4(s - t, 1 / n);
      return o *= r, o
    }
    ConnectTo(e) {
      this._wetNode.disconnect(), this._wetNode.connect(e), this._dryNode.disconnect(), this._dryNode.connect(e)
    ...
    SetParam(e, t, i, n) {
      0 === e && (t = Math.max(Math.min(t / 100, 1), 0), this._params[4] = t, this.SetAudioParam(this._wetNode.gain, t, i, n), this.SetAudioParam(this._dryNode.gain, 1 - t, i, n))
    }
  }, self.C3AudioCompressorFX = class extends ne {
    constructor(e, t, i, n, r, s) {
      super(e), this._type = "compressor", this._params = [t, i, n, r, s], this._node = this._audioContext.createDynamicsCompressor(), this._node.threshold.value = t, this._node.knee.value = i, this._node.ratio.value = n, this._node.attack.value = r, this._node.release.value = s
    }
    Release() {
      this._node.disconnect(), super.Release()
    }
  ...
  "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).EBML = e()
}(function() {
  return function e(t, i, n) {
    ...
    2: [function(e, t, i) {
      ...
      var n, r = e("./tools"),
        s = e("int64-buffer"),
        o = e("./tools"),
        a = e("matroska/lib/schema").byEbmlID;
      ! function(e) {
        e[e.STATE_TAG = 1] = "STATE_TAG", e[e.STATE_SIZE = 2] = "STATE_SIZE", e[e.STATE_CONTENT = 3] = "STATE_CONTENT"
      }(n || (n = {}));
      var l = function() {
        function e() {
          this._buffer = new r.Buffer(0), this._tag_stack = [], this._state = n.STATE_TAG, this._cursor = 0, this._total = 0, this._schema = a, this._result = []
        }
        return e.prototype.decode = function(e) {
          ...
          for (this._buffer = o.concat([this._buffer, new r.Buffer(e)]); this._cursor < this._buffer.length && (this._state !== n.STATE_TAG || this.readTag()) && (this._state !== n.STATE_SIZE || this.readSize()) && (this._state !== n.STATE_CONTENT || this.readContent()););
          ...
          var e = r.readVint(this._buffer, this._cursor);
          if (null == e) return !1;
          var t = this._buffer.slice(this._cursor, this._cursor + e.length).reduce(function(e, t, i, n) {
              return e + t * Math.pow(16, 2 * (n.length - 1 - i))
            }, 0),
            i = this.getSchemaInfo(t),
            s = {
          ...
          return this._tag_stack.push(s), this._cursor += e.length, this._total += e.length, this._state = n.STATE_SIZE, !0
        }, e.prototype.readSize = function() {
          if (this._cursor >= this._buffer.length) return !1;
          var e = r.readVint(this._buffer, this._cursor);
          if (null == e) return !1;
          var t = this._tag_stack[this._tag_stack.length - 1];
          return t.sizeEnd = t.sizeStart + e.length, t.dataStart = t.sizeEnd, t.dataSize = e.value, -1 === e.value ? (t.dataEnd = -1, "m" === t.type && (t.unknownSize = !0)) : t.dataEnd = t.sizeEnd + e.value, this._cursor += e.length, this._total += e.length, this._state = n.STATE_CONTENT, !0
        }, e.prototype.readContent = function() {
          var e = this._tag_stack[this._tag_stack.length - 1];
          if ("m" === e.type) {
            if (e.isEnd = !1, this._result.push(e), this._state = n.STATE_TAG, 0 === e.dataSize) {
              var t = Object.assign({}, e, {
                isEnd: !0
              });
              this._result.push(t), this._tag_stack.pop()
            }
            return !0
          }
          if (this._buffer.length < this._cursor + e.dataSize) return !1;
          var i = this._buffer.slice(this._cursor, this._cursor + e.dataSize);
          switch (this._buffer = this._buffer.slice(this._cursor + e.dataSize), e.data = i, e.type) {
            case "u":
              e.value = i.readUIntBE(0, i.length);
              break;
            case "i":
              e.value = i.readIntBE(0, i.length);
              break;
            case "f":
              e.value = 4 === e.dataSize ? i.readFloatBE(0) : 8 === e.dataSize ? i.readDoubleBE(0) : (console.warn("cannot read " + e.dataSize + " octets float. failback to 0"), 0);
              break;
            case "s":
              e.value = i.toString("ascii");
              break;
            case "8":
              e.value = i.toString("utf8");
              break;
            case "b":
              e.value = i;
              break;
            case "d":
              e.value = r.convertEBMLDateToJSDate(new s.Int64BE(i).toNumber())
          }
          if (null === e.value) throw new Error("unknown tag type:" + e.type);
          for (this._result.push(e), this._total += e.dataSize, this._state = n.STATE_TAG, this._cursor = 0, this._tag_stack.pop(); this._tag_stack.length > 0;) {
            var o = this._tag_stack[this._tag_stack.length - 1];
            if (o.dataEnd < 0) return this._tag_stack.pop(), !0;
            if (this._total < o.dataEnd) break;
            if ("m" !== o.type) throw new Error("parent element is not master element");
            t = Object.assign({}, o, {
              isEnd: !0
            }), this._result.push(t), this._tag_stack.pop()
          }
    ...
    3: [function(e, t, i) {
      ...
      var n = e("./tools"),
        r = e("./tools"),
        s = e("matroska/lib/schema").byEbmlID,
        o = function() {
          function e() {
            this._schema = s, this._buffers = [], this._stack = []
          }
          return e.prototype.encode = function(e) {
            var t = this;
            return n.concat(e.reduce(function(e, i) {
              return e.concat(t.encodeChunk(i))
            }, [])).buffer
          }, e.prototype.encodeChunk = function(e) {
            return "m" === e.type ? e.isEnd ? this.endTag(e) : this.startTag(e) : (e.data = r.Buffer.from(e.data), this.writeTag(e)), this.flush()
          }, e.prototype.flush = function() {
            var e = this._buffers;
            return this._buffers = [], e
          }, e.prototype.getSchemaInfo = function(e) {
            for (var t = Object.keys(this._schema).map(Number), i = 0; i < t.length; i++) {
              var n = t[i];
              if (this._schema[n].name === e) return new r.Buffer(n.toString(16), "hex")
            }
            return null
            ...
            var t = e.name,
              i = this.getSchemaInfo(t),
              r = e.data;
            if (null == i) throw new Error("No schema entry found for " + t);
            var s = n.encodeTag(i, r);
            this._stack.length > 0 ? this._stack[this._stack.length - 1].children.push({
              tagId: i,
              elm: e,
              children: [],
              data: s
            }) : this._buffers = this._buffers.concat(s)
          }, e.prototype.startTag = function(e) {
            var t = e.name,
              i = this.getSchemaInfo(t);
            if (null == i) throw new Error("No schema entry found for " + t);
            if (e.unknownSize) {
              var s = n.encodeTag(i, new r.Buffer(0), e.unknownSize);
              this._buffers = this._buffers.concat(s)
            } else {
              var o = {
                tagId: i,
              ...
              this._stack.length > 0 && this._stack[this._stack.length - 1].children.push(o), this._stack.push(o)
            }
            ...
            var i = t.children.reduce(function(e, t) {
                if (null === t.data) throw new Error("EBML structure is broken");
                return e.concat(t.data)
              }, []),
              r = n.concat(i);
            "m" === t.elm.type ? t.data = n.encodeTag(t.tagId, r, t.elm.unknownSize) : t.data = n.encodeTag(t.tagId, r), this._stack.length < 1 && (this._buffers = this._buffers.concat(t.data))
          }, e
        }();
      i.default = o
    }, {
        ...
        a = function(e) {
          function t() {
            ...
            return t.logGroup = "", t.hasLoggingStarted = !1, t.metadataloaded = !1, t.chunks = [], t.stack = [], t.segmentOffset = 0, t.last2SimpleBlockVideoTrackTimecode = [0, 0], t.last2SimpleBlockAudioTrackTimecode = [0, 0], t.lastClusterTimecode = 0, t.lastClusterPosition = 0, t.timecodeScale = 1e6, t.metadataSize = 0, t.metadatas = [], t.cues = [], t.firstVideoBlockRead = !1, t.firstAudioBlockRead = !1, t.currentTrack = {
              ...
              CodecDelay: null
            }, t.trackTypes = [], t.trackDefaultDuration = [], t.trackCodecDelay = [], t.trackInfo = {
              type: "nothing"
            }, t.ended = !1, t.logging = !1, t.use_duration_every_simpleblock = !1, t.use_webp = !1, t.use_segment_info = !0, t.drop_default_duration = !0, t
          }
          return r(t, e), t.prototype.stop = function() {
            ...
            if (this.chunks = [], this.metadataloaded) {
              ...
              var r = this.trackTypes.indexOf(1),
                s = this.trackTypes.indexOf(2);
              if (this.trackInfo = r >= 0 && s >= 0 ? {
                  type: "both",
                  trackNumber: r
                } : r >= 0 ? {
                  type: "video",
            ...
            if (!this.ended) {
              if ("m" === e.type)
                if (e.isEnd) this.stack.pop();
                else {
                  var n = this.stack[this.stack.length - 1];
                  if (null != n && n.level >= e.level) {
                    this.stack.pop(), this.logging && console.groupEnd(), n.dataEnd = e.dataEnd, n.dataSize = e.dataEnd - n.dataStart, n.unknownSize = !1;
                  ...
                  this.stack.push(e)
                } if ("m" === e.type && "Segment" == e.name) 0 != this.segmentOffset && console.warn("Multiple segments detected!"), this.segmentOffset = e.dataStart, this.emit("segment_offset", this.segmentOffset);
              else if ("b" === e.type && "SimpleBlock" === e.name) {
                var s = o.ebmlBlock(e.data),
                  a = s.timecode,
                  l = s.trackNumber,
                  d = s.frames;
                if (1 === this.trackTypes[l]) {
                  if (!this.firstVideoBlockRead && (this.firstVideoBlockRead = !0, "both" === this.trackInfo.type || "video" === this.trackInfo.type)) {
                    var c = this.lastClusterTimecode + a;
                    this.cues.push({
                      CueTrack: l,
                  ...
                  this.last2SimpleBlockVideoTrackTimecode = [this.last2SimpleBlockVideoTrackTimecode[1], a]
                } else 2 === this.trackTypes[l] && (this.firstAudioBlockRead || (this.firstAudioBlockRead = !0, "audio" !== this.trackInfo.type) || (c = this.lastClusterTimecode + a, this.cues.push({
                  CueTrack: l,
                  CueClusterPosition: this.lastClusterPosition,
                  CueTime: c
                }), this.emit("cue_info", {
                  ...
                  CueClusterPosition: this.lastClusterPosition,
                  CueTime: c
                })), this.last2SimpleBlockAudioTrackTimecode = [this.last2SimpleBlockAudioTrackTimecode[1], a]);
                this.use_duration_every_simpleblock && this.emit("duration", {
                  timecodeScale: this.timecodeScale,
                  duration: this.duration
                }), this.use_webp && d.forEach(function(e) {
                  if ("9d012a" === e.slice(3, 6).toString("hex")) {
                    var i = o.VP8BitStreamToRiffWebPBuffer(e),
                      n = new Blob([i], {
                        type: "image/webp"
                      }),
                      r = t.duration;
              ...
              !this.metadataloaded && e.dataEnd > 0 && (this.metadataSize = e.dataEnd), i || this.chunks.push(e), this.logging && this.put(e)
            }
            ...
            get: function() {
              ...
              var e = 0,
                t = 0,
                i = 0,
                n = this.trackDefaultDuration[this.trackInfo.trackNumber];
              if ("number" == typeof n) e = n;
              else if ("both" === this.trackInfo.type) this.last2SimpleBlockAudioTrackTimecode[1] > this.last2SimpleBlockVideoTrackTimecode[1] ? (e = (this.last2SimpleBlockAudioTrackTimecode[1] - this.last2SimpleBlockAudioTrackTimecode[0]) * this.timecodeScale, "number" == typeof(r = this.trackCodecDelay[this.trackTypes.indexOf(2)]) && (t = r), i = this.last2SimpleBlockAudioTrackTimecode[1]) : (e = (this.last2SimpleBlockVideoTrackTimecode[1] - this.last2SimpleBlockVideoTrackTimecode[0]) * this.timecodeScale, "number" == typeof(r = this.trackCodecDelay[this.trackTypes.indexOf(1)]) && (t = r), i = this.last2SimpleBlockVideoTrackTimecode[1]);
              else if ("video" === this.trackInfo.type) e = (this.last2SimpleBlockVideoTrackTimecode[1] - this.last2SimpleBlockVideoTrackTimecode[0]) * this.timecodeScale, "number" == typeof(r = this.trackCodecDelay[this.trackInfo.trackNumber]) && (t = r), i = this.last2SimpleBlockVideoTrackTimecode[1];
              else if ("audio" === this.trackInfo.type) {
                var r;
                e = (this.last2SimpleBlockAudioTrackTimecode[1] - this.last2SimpleBlockAudioTrackTimecode[0]) * this.timecodeScale, "number" == typeof(r = this.trackCodecDelay[this.trackInfo.trackNumber]) && (t = r), i = this.last2SimpleBlockAudioTrackTimecode[1]
              }
              var s = ((this.lastClusterTimecode + i) * this.timecodeScale + e - t) / this.timecodeScale;
              return Math.floor(s)
            },
            enumerable: !1,
            configurable: !0
          }), t.prototype.addListener = function(t, i) {
            return e.prototype.addListener.call(this, t, i)
    ...
    5: [function(e, t, i) {
      ...
      Object.defineProperty(i, "__esModule", {
        value: !0
      }), i.tools = i.Reader = i.Encoder = i.Decoder = i.version = void 0, r(e("./EBML"), i);
      var s = e("./EBMLDecoder");
      i.Decoder = s.default;
      var o = e("./EBMLEncoder");
      i.Encoder = o.default;
    ...
    6: [function(e, t, i) {
      Object.defineProperty(i, "__esModule", {
        value: !0
      }), i.convertEBMLDateToJSDate = i.createFloatBuffer = i.createIntBuffer = i.createUIntBuffer = i.encodeValueToBuffer = i.concat = i.putRefinedMetaData = i.extractElement = i.removeElement = i.makeMetadataSeekable = i.createRIFFChunk = i.VP8BitStreamToRiffWebPBuffer = i.WebPBlockFilter = i.WebPFrameFilter = i.encodeTag = i.readBlock = i.ebmlBlock = i.writeVint = i.readVint = i.Buffer = void 0;
      var n = e("int64-buffer"),
        r = e("./EBMLEncoder"),
        s = e("buffer/"),
        o = e("ebml/lib/ebml/tools"),
        a = e("ebml-block");

      function l(e) {
        return e.reduce(function(e, t) {
          return "b" !== t.type || "SimpleBlock" !== t.name ? e : i.ebmlBlock(t.data).frames.some(function(e) {
      ...
      function d(e) {
        var t = c("VP8 ", e);
        return c("RIFF", _([new i.Buffer("WEBP", "ascii"), t]))
      }

      function c(e, t) {
        var n = new i.Buffer(4);
        return n.writeUInt32LE(t.byteLength, 0), _([new i.Buffer(e.substr(0, 4), "ascii"), n, t, new i.Buffer(t.byteLength % 2 == 0 ? 0 : 1)])
      }
      ...
      function u(e, t) {
        for (var i = -1, n = 0; n < t.length; n++) {
          var r = t[n];
          if (r.name === e) {
            if ("m" !== r.type) return void t.splice(n, 1);
            if (r.isEnd) {
              if (-1 == i) throw new Error("Detected " + e + " closing element before finding the start");
              return void t.splice(i, n - i + 1)
            }
            i = n
          }
        }
      ...
      function m(e, t, n) {
        ...
        if ("number" == typeof r) {
          ...
          a.forEach(function(e) {
            "f" === e.type && "Duration" === e.name && (l = !0, e.data = v(r, 8))
          }), l || f(a, "Info", [{
            name: "Duration",
            type: "f",
            data: v(r, 8)
        ...
        Array.isArray(o) && f(a, "Cues", function(e, t) {
          var i = [];
        ...
        var d = [];
        return Array.isArray(s) && (console.warn("append cluster pointers to seekhead is deprecated. please use cues"), d = function(e, t) {
          var n = [];
          return e.forEach(function(e) {
            n.push({
              name: "Seek",
              ...
              name: "SeekID",
              type: "b",
              data: new i.Buffer([31, 67, 182, 117])
            }), n.push({
              name: "SeekPosition",
              type: "u",
              data: y(e + t)
      ...
      function f(e, t, i, n) {
        ...
        for (var r = -1, s = 0; s < e.length; s++) {
          var o = e[s];
          if ("m" === o.type && o.name === t && !1 === o.isEnd) {
            r = s;
            break
          }
        }
        r >= 0 ? Array.prototype.splice.apply(e, [r + 1, 0].concat(i)) : n ? [].concat([{
          name: t,
          type: "m",
          isEnd: !1
        }], i, [{
      ...
      function _(e) {
        return i.Buffer.concat(e)
      }

      function y(e) {
        for (var t = 1; e >= Math.pow(2, 8 * t); t++);
        if (t >= 7) return console.warn("7bit or more bigger uint not supported."), new n.Uint64BE(e).toBuffer();
        var r = new i.Buffer(t);
        return r.writeUIntBE(e, 0, t), r
      }

      function g(e) {
        for (var t = 1; e >= Math.pow(2, 8 * t); t++);
        if (t >= 7) return console.warn("7bit or more bigger uint not supported."), new n.Int64BE(e).toBuffer();
        var r = new i.Buffer(t);
        return r.writeIntBE(e, 0, t), r
      }

      function v(e, t) {
        var n;
        if (void 0 === t && (t = 8), 8 === t) return (n = new i.Buffer(8)).writeDoubleBE(e, 0), n;
        if (4 === t) return (n = new i.Buffer(4)).writeFloatBE(e, 0), n;
        throw new Error("float type bits must 4bytes or 8bytes")
      }
      i.Buffer = s.Buffer, i.readVint = o.readVint, i.writeVint = o.writeVint, i.ebmlBlock = a, i.readBlock = function(e) {
        return i.ebmlBlock(new i.Buffer(e))
      }, i.encodeTag = function(e, t, n) {
        return void 0 === n && (n = !1), _([e, n ? new i.Buffer("01ffffffffffffff", "hex") : i.writeVint(t.length), t])
      }, i.WebPFrameFilter = function(e) {
        return l(e).reduce(function(e, t) {
          return i.ebmlBlock(t.data).frames.reduce(function(e, t) {
            var i = d(t),
              n = new Blob([i], {
                type: "image/webp"
              });
      ...
      }, i.WebPBlockFilter = l, i.VP8BitStreamToRiffWebPBuffer = d, i.createRIFFChunk = c, i.makeMetadataSeekable = function(e, t, n) {
        var s = h("EBML", e),
          o = p(s) + 12,
          a = e[e.length - 1].dataEnd - o,
          l = h("Info", e);
        u("Duration", l), l.splice(1, 0, {
          name: "Duration",
          type: "f",
          data: v(t, 8)
        });
        for (var d = p(l), c = h("Tracks", e), m = p(c), f = 47, _ = [], g = 5 + 15 * n.length, w = [], b = -1, S = function(e) {
            var t = f,
              r = t + d,
              s = r + m,
              l = s + g - a;
            if ((_ = []).push({
                ...
                name: "SeekID",
                type: "b",
                data: new i.Buffer([21, 73, 169, 102])
              }), _.push({
                name: "SeekPosition",
                type: "u",
                data: y(t)
                ...
                name: "SeekID",
                type: "b",
                data: new i.Buffer([22, 84, 174, 107])
              }), _.push({
                name: "SeekPosition",
                type: "u",
                data: y(r)
                ...
                name: "SeekID",
                type: "b",
                data: new i.Buffer([28, 83, 187, 107])
              }), _.push({
                name: "SeekPosition",
                type: "u",
                data: y(s)
                ...
                type: "m",
                isEnd: !0
              }), g = p(w), b === l) return "break";
            if (b = l, 9 === e) throw new Error("Failed to converge to a stable metadata size")
          }, k = 0; k < 10 && "break" !== S(k); k++);
        var T = [].concat.apply([], [s, {
          name: "Segment",
          type: "m",
          isEnd: !1,
          unknownSize: !0
        }, _, l, c, w]);
        return (new r.default).encode(T)
      }, i.removeElement = u, i.extractElement = h, i.putRefinedMetaData = function(e, t) {
        Array.isArray(t.cueInfos) && !Array.isArray(t.cues) && (console.warn("putRefinedMetaData: info.cueInfos property is deprecated. please use info.cues"), t.cues = t.cueInfos);
        for (var n = [], s = [], o = 0; o < e.length; o++) {
          var a = e[o];
          if ("m" === a.type && "Segment" === a.name) {
            if (n = e.slice(0, o), s = e.slice(o), a.unknownSize) {
              s.shift();
              break
            }
        ...
        if (!(s[s.length - 1].dataEnd > 0)) throw new Error("metadata dataEnd has wrong number");
        var l, d = s[s.length - 1].dataEnd,
          c = n[n.length - 1].dataEnd,
          u = (new r.default).encode(n).byteLength - c,
          h = d - s[0].tagStart,
          p = (s[0].tagStart, s[0].tagStart, new i.Buffer([24, 83, 128, 103])),
          f = new i.Buffer("01ffffffffffffff", "hex"),
          _ = p.byteLength + f.byteLength,
          y = h;
        for (l = 1; l < 20; l++) {
          var g = m(s, u + (c + _ + y - d), t),
            v = (new r.default).encode(g).byteLength;
          if (v === y) return (new r.default).encode([].concat(n, [{
            type: "m",
            name: "Segment",
            isEnd: !1,
            unknownSize: !0
      ...
      }, i.concat = _, i.encodeValueToBuffer = function(e) {
        var t = new i.Buffer(0);
        ...
        switch (e.type) {
          ...
          case "f":
            ...
            break;
          case "s":
            t = new i.Buffer(e.value, "ascii");
            break;
          case "8":
            t = new i.Buffer(e.value, "utf8");
            break;
          case "b":
            t = e.value;
            break;
          case "d":
            t = new n.Int64BE(e.value.getTime().toString()).toBuffer()
        }
        return Object.assign({}, e, {
          data: t
        })
      }, i.createUIntBuffer = y, i.createIntBuffer = g, i.createFloatBuffer = v, i.convertEBMLDateToJSDate = function(e) {
    ...
    7: [function(e, t, i) {
      i.byteLength = function(e) {
        ...
        var t, i, n = l(e),
          ...
          c = 0,
          u = a > 0 ? o - 4 : o;
        for (i = 0; i < u; i += 4) t = r[e.charCodeAt(i)] << 18 | r[e.charCodeAt(i + 1)] << 12 | r[e.charCodeAt(i + 2)] << 6 | r[e.charCodeAt(i + 3)], d[c++] = t >> 16 & 255, d[c++] = t >> 8 & 255, d[c++] = 255 & t;
        return 2 === a && (t = r[e.charCodeAt(i)] << 2 | r[e.charCodeAt(i + 1)] >> 4, d[c++] = 255 & t), 1 === a && (t = r[e.charCodeAt(i)] << 10 | r[e.charCodeAt(i + 1)] << 4 | r[e.charCodeAt(i + 2)] >> 2, d[c++] = t >> 8 & 255, d[c++] = 255 & t), d
      }, i.fromByteArray = function(e) {
        for (var t, i = e.length, r = i % 3, s = [], o = 16383, a = 0, l = i - r; a < l; a += o) s.push(c(e, a, a + o > l ? l : a + o));
        return 1 === r ? (t = e[i - 1], s.push(n[t >> 2] + n[t << 4 & 63] + "==")) : 2 === r && (t = (e[i - 2] << 8) + e[i - 1], s.push(n[t >> 10] + n[t >> 4 & 63] + n[t << 2 & 63] + "=")), s.join("")
      };
      for (var n = [], r = [], s = "undefined" != typeof Uint8Array ? Uint8Array : Array, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", a = 0; a < 64; ++a) n[a] = o[a], r[o.charCodeAt(a)] = a;
      ...
      function c(e, t, i) {
        for (var n, r = [], s = t; s < i; s += 3) n = (e[s] << 16 & 16711680) + (e[s + 1] << 8 & 65280) + (255 & e[s + 2]), r.push(d(n));
        return r.join("")
      }
    ...
    8: [function(e, t, i) {
      (function(t) {
        (function() {
          ...
          i.Buffer = a, i.SlowBuffer = function(e) {
          ...
          function l(e, t, i) {
            ...
            if (U(e, ArrayBuffer) || e && U(e.buffer, ArrayBuffer)) return h(e, t, i);
            if ("undefined" != typeof SharedArrayBuffer && (U(e, SharedArrayBuffer) || e && U(e.buffer, SharedArrayBuffer))) return h(e, t, i);
            if ("number" == typeof e) throw new TypeError('The "value" argument must not be of type number. Received type number');
            var n = e.valueOf && e.valueOf();
            if (null != n && n !== e) return a.from(n, t, i);
            var r = function(e) {
              if (a.isBuffer(e)) {
                var t = 0 | p(e.length),
                  i = o(t);
              ...
              return void 0 !== e.length ? "number" != typeof e.length || H(e.length) ? o(0) : u(e) : "Buffer" === e.type && Array.isArray(e.data) ? u(e.data) : void 0
            }(e);
            if (r) return r;
          ...
          function u(e) {
            for (var t = e.length < 0 ? 0 : 0 | p(e.length), i = o(t), n = 0; n < t; n += 1) i[n] = 255 & e[n];
            return i
          }
          ...
          function h(e, t, i) {
            ...
            var n;
            return n = void 0 === t && void 0 === i ? new Uint8Array(e) : void 0 === i ? new Uint8Array(e, t) : new Uint8Array(e, t, i), Object.setPrototypeOf(n, a.prototype), n
          }
          ...
          function y(e, t, i, n, r) {
            ...
            if ("string" == typeof i ? (n = i, i = 0) : i > 2147483647 ? i = 2147483647 : i < -2147483648 && (i = -2147483648), H(i = +i) && (i = r ? 0 : e.length - 1), i < 0 && (i = e.length + i), i >= e.length) {
              if (r) return -1;
              i = e.length - 1
            } else if (i < 0) {
              if (!r) return -1;
            ...
            if ("string" == typeof t && (t = a.from(t, n)), a.isBuffer(t)) return 0 === t.length ? -1 : g(e, t, i, n, r);
            if ("number" == typeof t) return t &= 255, "function" == typeof Uint8Array.prototype.indexOf ? r ? Uint8Array.prototype.indexOf.call(e, t, i) : Uint8Array.prototype.lastIndexOf.call(e, t, i) : g(e, [t], i, n, r);
          ...
          function k(e, t, i, n) {
            return F(function(e, t) {
              for (var i, n, r, s = [], o = 0; o < e.length && !((t -= 2) < 0); ++o) n = (i = e.charCodeAt(o)) >> 8, r = i % 256, s.push(r), s.push(n);
              return s
            }(t, e.length - i), e, i, n)
          }

          function T(e, i, n) {
            return 0 === i && n === e.length ? t.fromByteArray(e) : t.fromByteArray(e.slice(i, n))
          }
          ...
          function E(e, t, i) {
            ...
            for (var n = [], r = t; r < i;) {
              ...
              if (r + u <= i) switch (u) {
                case 1:
                  ...
                  break;
                case 2:
                  128 == (192 & (s = e[r + 1])) && (l = (31 & d) << 6 | 63 & s) > 127 && (c = l);
                  break;
                case 3:
                  s = e[r + 1], o = e[r + 2], 128 == (192 & s) && 128 == (192 & o) && (l = (15 & d) << 12 | (63 & s) << 6 | 63 & o) > 2047 && (l < 55296 || l > 57343) && (c = l);
                  break;
                case 4:
                  s = e[r + 1], o = e[r + 2], a = e[r + 3], 128 == (192 & s) && 128 == (192 & o) && 128 == (192 & a) && (l = (15 & d) << 18 | (63 & s) << 12 | (63 & o) << 6 | 63 & a) > 65535 && l < 1114112 && (c = l)
              }
            ...
            return function(e) {
              ...
              for (var i = "", n = 0; n < t;) i += String.fromCharCode.apply(String, e.slice(n, n += C));
              return i
            }(n)
          }
          i.kMaxLength = s, a.TYPED_ARRAY_SUPPORT = function() {
            ...
            return function(e, t, i) {
              return d(e), e <= 0 ? o(e) : void 0 !== t ? "string" == typeof i ? o(e).fill(t, i) : o(e).fill(t) : o(e)
            }(e, t, i)
            ...
            if (U(e, Uint8Array) && (e = a.from(e, e.offset, e.byteLength)), U(t, Uint8Array) && (t = a.from(t, t.offset, t.byteLength)), !a.isBuffer(e) || !a.isBuffer(t)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
            if (e === t) return 0;
            ...
            for (i = 0; i < e.length; ++i) {
              var s = e[i];
              if (U(s, Uint8Array)) r + s.length > n.length ? a.from(s).copy(n, r) : Uint8Array.prototype.set.call(n, s, r);
              else {
          ...
          }, r && (a.prototype[r] = a.prototype.inspect), a.prototype.compare = function(e, t, i, n, r) {
            ...
            if (t >= i) return 1;
            if (this === e) return 0;
            for (var s = (r >>>= 0) - (n >>>= 0), o = (i >>>= 0) - (t >>>= 0), l = Math.min(s, o), d = this.slice(n, r), c = e.slice(t, i), u = 0; u < l; ++u)
              if (d[u] !== c[u]) {
                s = d[u], o = c[u];
                break
          ...
          function L(e, t, i, r, s) {
            return t = +t, i >>>= 0, s || x(e, 0, i, 4), n.write(e, t, i, r, 23, 4), i + 4
          }

          function D(e, t, i, r, s) {
            return t = +t, i >>>= 0, s || x(e, 0, i, 8), n.write(e, t, i, r, 52, 8), i + 8
          }
          a.prototype.slice = function(e, t) {
          ...
          }, a.prototype.writeUintLE = a.prototype.writeUIntLE = function(e, t, i, n) {
            e = +e, t >>>= 0, i >>>= 0, n || M(this, e, t, i, Math.pow(2, 8 * i) - 1, 0);
            var r = 1,
              s = 0;
            for (this[t] = 255 & e; ++s < i && (r *= 256);) this[t + s] = e / r & 255;
            return t + i
          }, a.prototype.writeUintBE = a.prototype.writeUIntBE = function(e, t, i, n) {
            e = +e, t >>>= 0, i >>>= 0, n || M(this, e, t, i, Math.pow(2, 8 * i) - 1, 0);
            var r = i - 1,
              s = 1;
            ...
            return e = +e, t >>>= 0, i || M(this, e, t, 1, 255, 0), this[t] = 255 & e, t + 1
          }, a.prototype.writeUint16LE = a.prototype.writeUInt16LE = function(e, t, i) {
            return e = +e, t >>>= 0, i || M(this, e, t, 2, 65535, 0), this[t] = 255 & e, this[t + 1] = e >>> 8, t + 2
          }, a.prototype.writeUint16BE = a.prototype.writeUInt16BE = function(e, t, i) {
            return e = +e, t >>>= 0, i || M(this, e, t, 2, 65535, 0), this[t] = e >>> 8, this[t + 1] = 255 & e, t + 2
          }, a.prototype.writeUint32LE = a.prototype.writeUInt32LE = function(e, t, i) {
            return e = +e, t >>>= 0, i || M(this, e, t, 4, 4294967295, 0), this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e, t + 4
          }, a.prototype.writeUint32BE = a.prototype.writeUInt32BE = function(e, t, i) {
            return e = +e, t >>>= 0, i || M(this, e, t, 4, 4294967295, 0), this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e, t + 4
            ...
            return e = +e, t >>>= 0, i || M(this, e, t, 1, 127, -128), e < 0 && (e = 255 + e + 1), this[t] = 255 & e, t + 1
          }, a.prototype.writeInt16LE = function(e, t, i) {
            return e = +e, t >>>= 0, i || M(this, e, t, 2, 32767, -32768), this[t] = 255 & e, this[t + 1] = e >>> 8, t + 2
          }, a.prototype.writeInt16BE = function(e, t, i) {
            return e = +e, t >>>= 0, i || M(this, e, t, 2, 32767, -32768), this[t] = e >>> 8, this[t + 1] = 255 & e, t + 2
          }, a.prototype.writeInt32LE = function(e, t, i) {
            return e = +e, t >>>= 0, i || M(this, e, t, 4, 2147483647, -2147483648), this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24, t + 4
          }, a.prototype.writeInt32BE = function(e, t, i) {
            return e = +e, t >>>= 0, i || M(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e, t + 4
            ...
            if (t >>>= 0, i = void 0 === i ? this.length : i >>> 0, e || (e = 0), "number" == typeof e)
              ...
              for (s = 0; s < i - t; ++s) this[s + t] = o[s % l]
            }
            return this
          };
          var B = /[^+/0-9A-Za-z-_]/g;
          ...
          function G(e, t) {
            var i;
            t = t || 1 / 0;
            for (var n = e.length, r = null, s = [], o = 0; o < n; ++o) {
    ...
    9: [function(e, t, i) {
      var n = e("./lib/buffer-reader");
      t.exports = function(e) {
        var t = {},
          i = new n(e);
        t.trackNumber = i.nextUIntV(), t.timecode = i.nextInt16BE();
        var r = i.nextUInt8();
        t.invisible = !!(8 & r), t.keyframe = !!(128 & r), t.discardable = !!(1 & r);
        var s = (6 & r) >> 1;
        return t.frames = function(e, t) {
          ...
          var i, n, r = [],
            s = e.nextUInt8() + 1;
          if (2 === t) {
            if (e.length % s !== 0) throw new Error("Fixed-Size Lacing Error");
            for (n = e.length / s, i = 0; i < s; i++) r.push(e.nextBuffer(n));
            return r
          }
          var o = [];
          if (1 === t)
            for (i = 0; i < s - 1; i++) {
              ...
              for (n = e.nextUIntV(), o.push(n), i = 1; i < s - 1; i++) n += e.nextIntV(), o.push(n);
          for (i = 0; i < s - 1; i++) r.push(e.nextBuffer(o[i]));
          return r.push(e.nextBuffer()), r
        }(i, s), t
      }
    }, {
    ...
    10: [function(e, t, i) {
      ...
      r.prototype.nextInt16BE = function() {
        ...
        var e = n(this.buffer, this.offset);
        return this.offset += e.length, e.value
      }, r.prototype.nextIntV = function() {
        var e = n(this.buffer, this.offset, !0);
        return this.offset += e.length, e.value
    ...
    11: [function(e, t, i) {
      t.exports = function(e, t, i) {
        ...
        var r, s = e[t] & (1 << 8 - n) - 1;
        for (r = 1; r < n; r++) {
          if (7 === r && s >= Math.pow(2, 45) && e[t + 7] > 0) return {
            length: n,
            value: -1
          };
          s *= Math.pow(2, 8), s += e[t + r]
        }
        return i && (s -= Math.pow(2, 7 * n - 1) - 1), {
          length: n,
          value: s
        }
      }
        ...
        (function() {
          var i = {
            readVint: function(e, t) {
              ...
              if (i > 8) throw new Error("Unrepresentable length: " + i + " " + e.toString("hex", t, t + i));
              if (t + i > e.length) return null;
              for (var n = e[t] & (1 << 8 - i) - 1, r = 1; r < i; r++) {
                if (7 === r && n >= Math.pow(2, 45) && e[t + 7] > 0) return {
                  length: i,
                  value: -1
                };
                n *= Math.pow(2, 8), n += e[t + r]
              }
              return {
                length: i,
                value: n
            ...
            writeVint: function(t) {
              if (t < 0 || t > Math.pow(2, 53)) throw new Error("Unrepresentable value: " + t);
              for (var i = 1; i <= 8 && !(t < Math.pow(2, 7 * i) - 1); i++);
              for (var n = new e(i), r = 1; r <= i; r++) {
                var s = 255 & t;
                n[i - r] = s, t -= s, t /= Math.pow(2, 8)
              }
              return n[0] = n[0] | 1 << 8 - i, n
            }
          };
          t.exports = i
        }).call(this)
    ...
    13: [function(e, t, i) {
      ...
      i.read = function(e, t, i, n, r) {
        var s, o, a = 8 * r - n - 1,
          ...
          h = i ? -1 : 1,
          p = e[t + u];
        for (u += h, s = p & (1 << -c) - 1, p >>= -c, c += a; c > 0; s = 256 * s + e[t + u], u += h, c -= 8);
        for (o = s & (1 << -c) - 1, s >>= -c, c += n; c > 0; o = 256 * o + e[t + u], u += h, c -= 8);
        if (0 === s) s = 1 - d;
        else {
        ...
        var o, a, l, d = 8 * s - r - 1,
          ...
          m = n ? 1 : -1,
          f = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        for (t = Math.abs(t), isNaN(t) || t === 1 / 0 ? (a = isNaN(t) ? 1 : 0, o = c) : (o = Math.floor(Math.log(t) / Math.LN2), t * (l = Math.pow(2, -o)) < 1 && (o--, l *= 2), (t += o + u >= 1 ? h / l : h * Math.pow(2, 1 - u)) * l >= 2 && (o++, l /= 2), o + u >= c ? (a = 0, o = c) : o + u >= 1 ? (a = (t * l - 1) * Math.pow(2, r), o += u) : (a = t * Math.pow(2, u - 1) * Math.pow(2, r), o = 0)); r >= 8; e[i + p] = 255 & a, p += m, a /= 256, r -= 8);
        for (o = o << r | a, d += r; d > 0; e[i + p] = 255 & o, p += m, o /= 256, d -= 8);
        e[i + p - m] |= 128 * f
      }
    }, {}],
    14: [function(e, t, i) {
      (function(e) {
        (function() {
          ! function(t) {
            var i, n = "undefined",
              r = n !== typeof e && e,
              s = n !== typeof Uint8Array && Uint8Array,
              o = n !== typeof ArrayBuffer && ArrayBuffer,
              a = [0, 0, 0, 0, 0, 0, 0, 0],
            ...
            function c(e, l, c) {
              var b = l ? 0 : 4,
                ...
                I = "is" + e,
                O = "_" + I;
              return R.buffer = void 0, R.offset = 0, R[O] = !0, R.toNumber = x, R.toString = function(e) {
                var t = this.buffer,
                  i = this.offset,
                  n = D(t, i + b),
                  r = D(t, i + S),
                  s = "",
                  o = !c && 2147483648 & n;
                for (o && (n = ~n, r = d - r), e = e || 10;;) {
                  var a = n % e * d + r;
                  if (n = Math.floor(n / e), r = Math.floor(a / e), s = (a % e).toString(e) + s, !n && !r) break
                }
                return o && (s = "-" + s), s
              }, R.toJSON = x, R.toArray = u, r && (R.toBuffer = h), s && (R.toArrayBuffer = p), M[I] = function(e) {
                return !(!e || !e[O])
              }, t[e] = M, M;

              function M(e, t, r, l) {
                return this instanceof M ? function(e, t, r, l, c) {
                  s && o && (t instanceof o && (t = new s(t)), l instanceof o && (l = new s(l))), t || r || l || i ? (m(t, r) || (c = r, l = t, r = 0, t = new(i || Array)(8)), e.buffer = t, e.offset = r |= 0, n !== typeof l && ("string" == typeof l ? function(e, t, i, n) {
                    var r = 0,
                      s = i.length,
                      o = 0,
                      a = 0;
                    ...
                    for (var l = r; r < s;) {
                      ...
                      if (!(c >= 0)) break;
                      a = a * n + c, o = o * n + Math.floor(a / d), a %= d
                    }
                    l && (o = ~o, a ? a = d - a : o++), L(e, t + b, o), L(e, t + S, a)
                  }(t, r, l, c || 10) : m(l, c) ? f(t, r, l, c) : "number" == typeof c ? (L(t, r + b, l), L(t, r + S, c)) : l > 0 ? A(t, r, l) : l < 0 ? P(t, r, l) : f(t, r, a, 0))) : e.buffer = _(a, 0)
                }(this, e, t, r, l) : new M(e, t, r, l)
              }
              ...
              function x() {
                var e = this.buffer,
                  ...
                  i = D(e, t + b),
                  n = D(e, t + S);
                return c || (i |= 0), i ? i * d + n : n
              }

              function L(e, t, i) {
                e[t + C] = 255 & i, i >>= 8, e[t + E] = 255 & i, i >>= 8, e[t + T] = 255 & i, i >>= 8, e[t + k] = 255 & i
              }

              function D(e, t) {
                return 16777216 * e[t + k] + (e[t + T] << 16) + (e[t + E] << 8) + e[t + C]
              }
            }
            ...
            function u(e) {
              var t = this.buffer,
                n = this.offset;
              return i = null, !1 !== e && 0 === n && 8 === t.length && l(t) ? t : _(t, n)
            }

            function h(t) {
              var n = this.buffer,
                s = this.offset;
              if (i = r, !1 !== t && 0 === s && 8 === n.length && e.isBuffer(n)) return n;
              var o = new r(8);
              return f(o, 0, n, s), o
            }
            ...
            function p(e) {
              var t = this.buffer,
                n = this.offset,
                r = t.buffer;
              if (i = s, !1 !== e && 0 === n && r instanceof o && 8 === r.byteLength) return r;
              var a = new s(8);
              return f(a, 0, t, n), a.buffer
            }
    ...
    15: [function(e, t, i) {
      var n = {
          ...
          18402: {
            ...
            minver: 1,
            webm: !1,
            description: "For public key algorithms this is the ID of the public key the data was encrypted with."
          },
          18401: {
            name: "ContentEncAlgo",
            level: 6,
      ...
      for (var o in n) r[n[o].name.replace("-", "_")] = parseInt(o, 10);
      t.exports = s
    }, {}],
    16: [function(e, t, i) {
      t.exports = {
      ...
      (function(t) {
        (function() {
          ...
          function a(e, t, i) {
            ...
            if (U(e, ArrayBuffer) || e && U(e.buffer, ArrayBuffer)) return function(e, t, i) {
              if (t < 0 || e.byteLength < t) throw new RangeError('"offset" is outside of buffer bounds');
              if (e.byteLength < t + (i || 0)) throw new RangeError('"length" is outside of buffer bounds');
              var n;
              return (n = void 0 === t && void 0 === i ? new Uint8Array(e) : void 0 === i ? new Uint8Array(e, t) : new Uint8Array(e, t, i)).__proto__ = o.prototype, n
            }(e, t, i);
            if ("number" == typeof e) throw new TypeError('The "value" argument must not be of type number. Received type number');
            var n = e.valueOf && e.valueOf();
            if (null != n && n !== e) return o.from(n, t, i);
            var r = function(e) {
              if (o.isBuffer(e)) {
                var t = 0 | u(e.length),
                  i = s(t);
              ...
              return void 0 !== e.length ? "number" != typeof e.length || H(e.length) ? s(0) : c(e) : "Buffer" === e.type && Array.isArray(e.data) ? c(e.data) : void 0
            }(e);
            if (r) return r;
          ...
          function d(e) {
            return l(e), s(e < 0 ? 0 : 0 | u(e))
          }

          function c(e) {
            for (var t = e.length < 0 ? 0 : 0 | u(e.length), i = s(t), n = 0; n < t; n += 1) i[n] = 255 & e[n];
            return i
          }
          ...
          function f(e, t, i, n, r) {
            ...
            if ("string" == typeof t && (t = o.from(t, n)), o.isBuffer(t)) return 0 === t.length ? -1 : _(e, t, i, n, r);
            if ("number" == typeof t) return t &= 255, "function" == typeof Uint8Array.prototype.indexOf ? r ? Uint8Array.prototype.indexOf.call(e, t, i) : Uint8Array.prototype.lastIndexOf.call(e, t, i) : _(e, [t], i, n, r);
            throw new TypeError("val must be string, number or Buffer")
          }
          ...
          i.kMaxLength = r, o.TYPED_ARRAY_SUPPORT = function() {
            try {
              var e = new Uint8Array(1);
              return e.__proto__ = {
            ...
            if (U(e, Uint8Array) && (e = o.from(e, e.offset, e.byteLength)), U(t, Uint8Array) && (t = o.from(t, t.offset, t.byteLength)), !o.isBuffer(e) || !o.isBuffer(t)) throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
            if (e === t) return 0;
            for (var i = e.length, n = t.length, r = 0, s = Math.min(i, n); r < s; ++r)
              if (e[r] !== t[r]) {
                i = e[r], n = t[r];
            ...
            for (i = 0; i < e.length; ++i) {
              var s = e[i];
              if (U(s, Uint8Array) && (s = o.from(s)), !o.isBuffer(s)) throw new TypeError('"list" argument must be an Array of Buffers');
            ...
            var e = "",
              t = i.INSPECT_MAX_BYTES;
            return e = this.toString("hex", 0, t).replace(/(.{2})/g, "$1 ").trim(), this.length > t && (e += " ... "), "<Buffer " + e + ">"
          }, o.prototype.compare = function(e, t, i, n, r) {
            if (U(e, Uint8Array) && (e = o.from(e, e.offset, e.byteLength)), !o.isBuffer(e)) throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof e);
            if (void 0 === t && (t = 0), void 0 === i && (i = e ? e.length : 0), void 0 === n && (n = 0), void 0 === r && (r = this.length), t < 0 || i > e.length || n < 0 || r > this.length) throw new RangeError("out of range index");
            if (n >= r && t >= i) return 0;
            if (n >= r) return -1;
            if (t >= i) return 1;
            if (this === e) return 0;
            for (var s = (r >>>= 0) - (n >>>= 0), a = (i >>>= 0) - (t >>>= 0), l = Math.min(s, a), d = this.slice(n, r), c = e.slice(t, i), u = 0; u < l; ++u)
              if (d[u] !== c[u]) {
                s = d[u], a = c[u];
                break
            ...
            return f(this, e, t, i, !0)
          }, o.prototype.lastIndexOf = function(e, t, i) {
            return f(this, e, t, i, !1)
          ...
          function x(e, t, i, r, s) {
            return t = +t, i >>>= 0, s || M(e, 0, i, 4), n.write(e, t, i, r, 23, 4), i + 4
          }

          function L(e, t, i, r, s) {
            return t = +t, i >>>= 0, s || M(e, 0, i, 8), n.write(e, t, i, r, 52, 8), i + 8
          }
          o.prototype.slice = function(e, t) {
            ...
            e = +e, t >>>= 0, i >>>= 0, n || O(this, e, t, i, Math.pow(2, 8 * i) - 1, 0);
            var r = 1,
              s = 0;
            for (this[t] = 255 & e; ++s < i && (r *= 256);) this[t + s] = e / r & 255;
            return t + i
            ...
            n > this.length && (n = this.length), e.length - t < n - i && (n = e.length - t + i);
            var r = n - i;
            if (this === e && "function" == typeof Uint8Array.prototype.copyWithin) this.copyWithin(t, i, n);
            else if (this === e && i < t && t < n)
              for (var s = r - 1; s >= 0; --s) e[s + t] = this[s + i];
            else Uint8Array.prototype.set.call(e, this.subarray(i, n), t);
            return r
            ...
            if (t >>>= 0, i = void 0 === i ? this.length : i >>> 0, e || (e = 0), "number" == typeof e)
              ...
              var a = o.isBuffer(e) ? e : o.from(e, n),
                l = a.length;
              if (0 === l) throw new TypeError('The value "' + e + '" is invalid for argument "value"');
              for (s = 0; s < i - t; ++s) this[s + t] = a[s % l]
            }
            return this
          };
          var D = /[^+/0-9A-Za-z-_]/g;
    ...
    19: [function(e, t, i) {
      ...
      function u(e, t, i, n) {
        var r, s, o, a;
        if (d(i), void 0 === (s = e._events) ? (s = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== s.newListener && (e.emit("newListener", t, i.listener ? i.listener : i), s = e._events), o = s[t]), void 0 === o) o = s[t] = i, ++e._eventsCount;
        else if ("function" == typeof o ? o = s[t] = n ? [i, o] : [o, i] : n ? o.unshift(i) : o.push(i), (r = c(e)) > 0 && o.length > r && !o.warned) {
          o.warned = !0;
...
{
  const re = "game-recorder";
  async function se(e) {
    try {
      const i = self.EBML,
        n = await (t = e, new Promise((e, i) => {
          const n = new FileReader;
          n.onload = () => e(n.result), n.onerror = () => i(n.error), n.readAsArrayBuffer(t)
        })),
        r = new i.Decoder,
        s = new i.Reader;
      r.decode(n).forEach(e => s.read(e));
      const o = i.tools.makeMetadataSeekable(s.metadatas, s.duration, s.cues),
        a = n.slice(s.metadataSize);
      return new Blob([o, a], {
        type: e.type
      })
    } catch (t) {
      return console.error("Error making WebM seekable, returning original: ", t), e
    }
    var t
  }
  const oe = class extends self.DOMHandler {
    constructor(e) {
      super(e, re), this._mediaRecorder = null, this._mediaStream = null, this._stopStreamOnEnd = !0, this._recordedChunks = [], this._lastRecordingUrl = "", this.AddRuntimeMessageHandler("get-supported-formats", () => this._OnGetSupportedFormats()), this.AddRuntimeMessageHandler("start-recording", e => this._OnStartRecording(e)), this.AddRuntimeMessageHandler("start-screen-recording", e => this._OnStartScreenRecording(e)), this.AddRuntimeMessageHandler("start-user-media-recording", e => this._OnStartUserMediaRecording(e)), this.AddRuntimeMessageHandler("stop-recording", () => this._OnStopRecording())
    }
    _OnGetSupportedFormats() {
      const e = this._iRuntime.GetMainCanvas(),
        t = "undefined" != typeof MediaRecorder,
        i = !(!e.captureStream || !t),
        n = [],
        r = [];
      if (i) {
        const e = ["mp4", "webm"],
          t = ["avc1.420034", "hev1.1.2.L93.B0", "vp9", "vp8"],
          i = ["mp4a.40.2", "opus"];
        for (const s of e) {
          for (const e of t) {
            const t = `video/${s};codecs=${e}`;
            MediaRecorder.isTypeSupported(t) && n.push(t)
          }
          for (const e of i) {
            const t = `audio/${s};codecs=${e}`;
            MediaRecorder.isTypeSupported(t) && r.push(t)
          }
        }
      }
      return {
        isSupported: i,
        isMediaRecorderSupported: t,
        isScreenRecordingSupported: !(!navigator.mediaDevices || !navigator.mediaDevices.getDisplayMedia || "undefined" == typeof MediaRecorder),
        supportedVideoFormats: n,
        supportedAudioFormats: r
      }
    }
    _GetMimeTypeFromParts(e, t, i) {
      if (!e) return "";
      const n = [];
      return t && n.push(t), i && n.push(i), `${e};codecs=${n.join(",")}`
    }
    _StopStreamVideoTracks(e) {
      const t = e.getTracks();
    ...
    _StopAnyPriorRecording() {
      this._OnStopRecording(), this._recordedChunks.length = 0, this._lastRecordingUrl && (URL.revokeObjectURL(this._lastRecordingUrl), this._lastRecordingUrl = "")
    }
    _OnStartRecording(e) {
      const t = e.containerPart,
        i = e.videoPart;
      let n = e.audioPart;
      const r = e.bitsPerSecond,
        s = e.framerate;
      this._StopAnyPriorRecording();
      let o = [],
        a = [];
      try {
        if (i) {
          const e = this._iRuntime.GetMainCanvas();
          let t;
          t = s > 0 ? e.captureStream(s) : e.captureStream(), o = t.getVideoTracks()
        }
        n && self.C3Audio_GetOutputStream && (a = self.C3Audio_GetOutputStream().getAudioTracks()), 0 === a.length && (n = "");
        const e = this._GetMimeTypeFromParts(t, i, n);
        console.log(`[Video recorder] Recording with MIME type '${e}'`), this._mediaStream = new MediaStream([...o, ...a]), this._stopStreamOnEnd = !0, this._mediaRecorder = new MediaRecorder(this._mediaStream, {
          mimeType: e,
          bitsPerSecond: r
        }), this._StartMediaRecorder(e)
      } catch (e) {
        console.error("[Video Recorder] Failed to start recording: ", e), this.PostToRuntime("error")
      }
    }
    async _OnStartScreenRecording(e) {
      const t = e.containerPart,
        i = e.videoPart;
      let n = e.audioPart;
      const r = e.systemAudio && n,
        s = e.bitsPerSecond;
      this._StopAnyPriorRecording();
      let o = [],
        a = [];
      try {
        if (i) {
          const e = await navigator.mediaDevices.getDisplayMedia({
            ...
            systemAudio: r ? "include" : "exclude"
          });
          o = e.getVideoTracks(), r && (a = e.getAudioTracks())
        }
        n && 0 === a.length && self.C3Audio_GetOutputStream && (a = self.C3Audio_GetOutputStream().getAudioTracks()), 0 === a.length && (n = "");
        const e = this._GetMimeTypeFromParts(t, i, n);
        console.log(`[Video recorder] Recording with MIME type '${e}'`), this._mediaStream = new MediaStream([...o, ...a]), this._stopStreamOnEnd = !0, this._mediaStream.addEventListener("inactive", () => this._OnMediaStreamInactive()), this._mediaRecorder = new MediaRecorder(this._mediaStream, {
          mimeType: e,
          bitsPerSecond: s
        }), this._StartMediaRecorder(e)
      } catch (e) {
    ...
    async _OnStartUserMediaRecording(e) {
      const t = e.containerPart,
        i = e.videoPart,
        n = e.audioPart,
        r = e.bitsPerSecond;
      if (this._StopAnyPriorRecording(), !self.C3UserMedia_GetLastMediaStream) return;
      const s = self.C3UserMedia_GetLastMediaStream();
      if (s) try {
        this._mediaStream = s, this._stopStreamOnEnd = !1;
        const e = this._GetMimeTypeFromParts(t, i, n);
        console.log(`[Video recorder] Recording with MIME type '${e}'`), this._mediaRecorder = new MediaRecorder(this._mediaStream, {
          mimeType: e,
          bitsPerSecond: r
        }), this._StartMediaRecorder(e)
      } catch (e) {
    ...
    _StartMediaRecorder(e) {
      this._mediaRecorder.ondataavailable = e => {
        this._recordedChunks.push(e.data)
      }, this._mediaRecorder.onerror = e => {
        console.error("[Video Recorder] Error recording: ", e), this.PostToRuntime("error")
      }, this._mediaRecorder.onwarning = e => {
        console.warn("[Video Recorder] Recording warning: ", e)
      }, this._mediaRecorder.onstop = async t => {
        let i = new Blob(this._recordedChunks, {
          type: e
        });
        e.toLowerCase().includes("/webm") && (i = await se(i)), this._lastRecordingUrl = URL.createObjectURL(i), this.PostToRuntime("recording-ready", {
          url: this._lastRecordingUrl
        })
      }, this._mediaRecorder.start()
    }
    _OnMediaStreamInactive() {
      this.PostToRuntime("screen-recording-stopped"), this._OnStopRecording()
    }
    _OnStopRecording() {
      this._mediaRecorder && (this._mediaRecorder.stop(), this._mediaRecorder = null), this._mediaStream && (this._stopStreamOnEnd && this._StopStreamVideoTracks(this._mediaStream), this._mediaStream = null)
    }
  };
  self.RuntimeInterface.AddDOMHandlerClass(oe)
} {
  const ae = "platform-info";
  ...
  const he = class extends self.DOMHandler {
    constructor(e) {
      super(e, ae), this.AddRuntimeMessageHandlers([
    ...
    async _GetSafeAreaInset() {
      ...
      if (!e) {
        ...
        const i = getComputedStyle(e),
          n = [i.getPropertyValue("--temp-sai-top"), i.getPropertyValue("--temp-sai-right"), i.getPropertyValue("--temp-sai-bottom"), i.getPropertyValue("--temp-sai-left")].map(e => {
            const t = parseInt(e, 10);
            return isFinite(t) ? t : 0
          });
        return t.removeProperty("--temp-sai-top"), t.removeProperty("--temp-sai-right"), t.removeProperty("--temp-sai-bottom"), t.removeProperty("--temp-sai-left"), n
      }
      try {
        return await Promise.all([le(e), de(e), ce(e), ue(e)])
      } catch (e) {
  ...
  self.RuntimeInterface.AddDOMHandlerClass(he)
} {
  const pe = "clipboard";
  ...
  function me(e) {
    return new Promise((t, i) => {
      const n = new FileReader;
      n.onload = () => t(n.result), n.onerror = () => i(n.error), n.readAsArrayBuffer(e)
    })
  }
  const fe = class extends self.DOMHandler {
    constructor(e) {
      super(e, pe), this.AddRuntimeMessageHandlers([
        ["copy-text", e => this._OnCopyText(e)],
        ["copy-binary", e => this._OnCopyBinary(e)],
        ["request-paste-text", () => this._OnRequestPasteText()],
        ["request-paste-binary", () => this._OnRequestPasteBinary()]
      ]), window.addEventListener("paste", e => this._OnWindowPasteEvent(e))
    }
    async _OnCopyText(e) {
      const t = e.text;
      let i = !1;
      try {
        ...
        console.error("Failed to copy to clipboard: ", e), i = !1
      }
      this.PostToRuntime("copy-result", {
        isOk: i
      })
    }
    async _OnCopyBinary(e) {
      const t = e.arrayBuffer,
        i = e.type;
      let n = !1;
      try {
        const e = {};
        e[i] = new Blob([t], {
          type: i
        }), await navigator.clipboard.write([new ClipboardItem(e)]), n = !0
      } catch (e) {
        console.error("Failed to copy to clipboard: ", e), n = !1
      }
      this.PostToRuntime("copy-result", {
        isOk: n
      })
    }
    async _OnRequestPasteText() {
      let e = !1,
        t = "";
      try {
        t = await navigator.clipboard.readText(), e = !0
      } catch (i) {
        console.error("Failed to paste: ", i), t = "", e = !1
      }
      this.PostToRuntime("request-paste-text-result", {
        isOk: e,
        text: t
      })
    }
    async _OnRequestPasteBinary() {
      let e = !1,
        t = [];
      try {
        ...
        if (i.length >= 1) {
          const n = i[0],
            r = [],
            s = n.types;
          for (const e of s) r.push((async () => {
            const t = await n.getType(e);
            return await me(t)
          })());
          t = (await Promise.all(r)).map((e, t) => [s[t], e]), e = !0
        } else e = !1
      } catch (t) {
        console.error("Failed to paste: ", t), e = !1
      }
      this.PostToRuntime("request-paste-binary-result", {
        isOk: e,
        binary: t
      })
    }
    async _OnWindowPasteEvent(e) {
      const t = new Set(["canvas", "body", "html"]),
        i = e.target.tagName || "";
      if (!t.has(i.toLowerCase())) return;
      e.preventDefault();
      const n = e.clipboardData.getData("text");
      if (n) this.PostToRuntime("window-paste-text", {
        text: n
      });
      else if (e.clipboardData.files.length >= 1) {
        const t = e.clipboardData.files[0],
          i = await me(t);
        this.PostToRuntime("window-paste-binary", {
          arrayBuffer: i,
          type: t.type
        })
      }
  ...
  function ye() {
    const e = self.RealFile || self.File;
    return "function" == typeof navigator.canShare && navigator.canShare({
      files: [new e(["test file"], "test.txt", {})]
    })
  }
  const ge = class extends self.DOMHandler {
    constructor(e) {
      super(e, _e);
      const t = !!this._GetSharePlugin();
      this._isSupported = "function" == typeof navigator.share || t, this._isFilesSupported = ye() || t, this.AddRuntimeMessageHandlers([
    ...
    async _OnShare(e) {
      const t = e.text,
        ...
        r = e.files.slice(0),
        s = r.length > 0,
        o = this._GetSharePlugin();
      if (o) {
        const a = {};
        if (t && (a.message = t), i && (a.subject = i), n && (a.url = n), s) {
          let t = 0;
          for (const e of r) t += e.size;
          try {
            const e = await this._CordovaGetTempDirEntry(Math.floor(1.25 * t));
            a.files = await Promise.all(r.map(t => this._CordovaWriteTempFile(t, e)))
          } catch (e) {
            return console.log("[Share plugin] Share failed: ", e), void this.PostToRuntime("share-failed")
          }
        }
        o.shareWithOptions(a, () => {
          this.PostToRuntime("share-completed")
        }, e => {
          console.log("[Share plugin] Share failed: ", e), this.PostToRuntime("share-failed")
        })
      } else {
        const o = {};
        t && (o.text = t), i && (o.title = i), n && (o.url = n), s && (o.files = r);
        try {
          await navigator.share(o), this.PostToRuntime("share-completed")
        } catch (e) {
          console.log("[Share plugin] Share failed: ", e), this.PostToRuntime("share-failed")
        }
      }
    ...
    _OnRateApp(e) {
      const t = e.body,
        ...
        n = e.cancel,
        r = e.appID,
        s = this._GetRatePlugin();
      s && s.Rate(t, i, n, r)
    }
    _OnShowStore(e) {
      const t = e.appID,
        i = this._GetRatePlugin();
      i && i.Store(t)
    }
    _CordovaGetTempDirEntry(e) {
      return new Promise((t, i) => {
        window.requestFileSystem(window.TEMPORARY, e, e => t(e.root), i)
      })
    }
    _CordovaWriteTempFile(e, t) {
      return new Promise((i, n) => {
        t.getFile(e.name, {
          ...
          const r = t.toURL();
          t.createWriter(t => {
            t.onwriteend = () => i(r), t.onerror = n, t.write(e)
          })
        }, n)
      })
    }
  ...
  const Se = class extends self.DOMElementHandler {
    constructor(e) {
      super(e, ve), this.AddDOMElementMessageHandler("scroll-to-bottom", e => this._OnScrollToBottom(e))
    }
    CreateElement(e, t) {
      let i;
      const n = t.type;
      return "textarea" === n ? (i = document.createElement("textarea"), i.style.resize = "none") : (i = document.createElement("input"), i.type = n), i.style.position = "absolute", i.autocomplete = "off", i.addEventListener("pointerdown", we), i.addEventListener("pointerrawupdate", we), i.addEventListener("pointerup", we), i.addEventListener("mousedown", we), i.addEventListener("mouseup", we), i.addEventListener("keydown", be), i.addEventListener("keyup", be), i.addEventListener("click", t => {
      ...
      }), i.addEventListener("input", () => this.PostToRuntimeElement("change", e, {
        text: i.value
      })), t.id && (i.id = t.id), t.className && (i.className = t.className), this.UpdateState(i, t), i
    }
    UpdateState(e, t) {
  ...
  const Ee = class extends self.DOMElementHandler {
    constructor(e) {
      super(e, ke), this.AddDOMElementMessageHandler("set-selected-index", (e, t) => this._OnSetSelectedIndex(e, t.selectedIndex)), this.AddDOMElementMessageHandler("add-item", (e, t) => this._OnAddItem(e, t)), this.AddDOMElementMessageHandler("remove-item", (e, t) => this._OnRemoveItem(e, t)), this.AddDOMElementMessageHandler("set-item", (e, t) => this._OnSetItem(e, t)), this.AddDOMElementMessageHandler("clear", e => this._OnClear(e)), this.AddDOMElementMessageHandler("load-state", (e, t) => this._OnLoadState(e, t))
    }
    CreateElement(e, t) {
      const i = t.isDropdown,
        n = t.isMultiSelect,
        r = t.items,
        s = document.createElement("select");
      s.style.position = "absolute", s.style.userSelect = "none", s.style.webkitUserSelect = "none", s.multiple = n, i || (s.size = 2);
      for (const e of r) s.add(this._CreateOption(e));
      return s.addEventListener("pointerdown", Te), s.addEventListener("pointerrawupdate", Te), s.addEventListener("pointerup", Te), s.addEventListener("mousedown", Te), s.addEventListener("mouseup", Te), s.addEventListener("click", t => {
        t.stopPropagation(), this._PostToRuntimeElementMaybeSync("click", e, this._GetSelectionState(s))
      }), s.addEventListener("dblclick", t => {
        t.stopPropagation(), this._PostToRuntimeElementMaybeSync("dblclick", e, this._GetSelectionState(s))
      }), s.addEventListener("change", () => this.PostToRuntimeElement("change", e, this._GetSelectionState(s))), t.id && (s.id = t.id), t.className && (s.className = t.className), this.UpdateState(s, t), s
    }
    _CreateOption(e) {
    ...
    _GetSelectionState(e) {
      const t = e.selectedIndex,
        i = [];
      for (let t = 0, n = e.length; t < n; ++t) e.options[t].selected && i.push(t);
      return {
        selectedIndex: t,
        selectedIndices: i
      }
    ...
    _OnAddItem(e, t) {
      const i = t.text,
        n = t.index,
        r = this._CreateOption(i);
      n < 0 ? e.add(r) : e.add(r, n)
    }
    _OnRemoveItem(e, t) {
      e.remove(t.index)
    }
    ...
    _OnLoadState(e, t) {
      e.innerHTML = "";
      for (const i of t.items) e.add(this._CreateOption(i));
      e.selectedIndex = t.selectedIndex;
      for (const i of t.selectedIndices) {
        const t = e.options[i];
        t && (t.selected = !0)
      }
    }
  ...
  function Ce(e) {
    return e && !e.paused && !e.ended && e.currentTime > 0
  }
  const Ae = "video",
    Pe = class extends self.DOMElementHandler {
      constructor(e) {
        super(e, Ae), this.SetAutoAttach(!1), this._isRuntimeInWorker = !1, this._supportsRvfc = !1, this._postImageBitmaps = !1, this._sequenceNumber = 0, this._numVideos = 0, this._destroyedVideos = new WeakSet, this.AddRuntimeMessageHandler("init", e => this._OnInit(e)), this.AddDOMElementMessageHandlers([
      ...
      async _OnInit(e) {
        ...
        this._supportsRvfc = !!t.requestVideoFrameCallback && !this._iRuntime.IsAndroidWebView();
        const i = !!self.createImageBitmap;
        return this._postImageBitmaps = this._isRuntimeInWorker || i, {
      ...
      async _OnVideoFrameCallback(e) {
        if (!this._destroyedVideos.has(e)) {
          ...
          try {
            ...
            t > e.c3_lastFrameSequence && (e.c3_imageBitmap = i, e.c3_lastFrameSequence = t)
          } catch (e) {}
        }
      }
      CreateElement(e, t) {
        const i = document.createElement("video");
        i.crossOrigin = "anonymous", i.playsInline = !0, i.c3_imageBitmap = null, i.c3_rvfcId = -1, i.c3_sequenceNumber = 0, i.c3_lastFrameSequence = -1, i.addEventListener("canplay", () => this._SendPlaybackEvent(i, e, 0)), i.addEventListener("canplaythrough", () => this._SendPlaybackEvent(i, e, 1)), i.addEventListener("ended", () => this._SendPlaybackEvent(i, e, 2)), i.addEventListener("error", () => this._SendPlaybackEvent(i, e, 3)), i.addEventListener("loadstart", () => this._SendPlaybackEvent(i, e, 4)), i.addEventListener("playing", () => this._SendPlaybackEvent(i, e, 5)), i.addEventListener("pause", () => this._SendPlaybackEvent(i, e, 6)), i.addEventListener("stalled", () => this._SendPlaybackEvent(i, e, 7));
        const n = t.autoplay;
        return 0 === n ? (i.autoplay = !1, i.preload = "none") : 1 === n ? (i.autoplay = !1, i.preload = "auto") : i.autoplay = !0, t.src && (i.src = t.src), 2 === n && this.TryPlayMedia(i), this._numVideos++, this._StartTicking(), i
      }
      _SendPlaybackEvent(e, t, i) {
      ...
      UpdateState(e, t) {}
      DestroyElement(e) {
        this.RemovePendingPlay(e), Ce(e) && e.pause(), e.src = "", this._numVideos = Math.max(this._numVideos - 1, 0), 0 === this._numVideos && this._StopTicking(), this._destroyedVideos.add(e)
      }
      _OnPlay(e) {
        this.TryPlayMedia(e)
      }
      ...
      Tick() {
        const e = {},
          ...
          i = [],
          n = [];
        for (const [t, r] of this._elementMap.entries()) {
          ...
          if (this._postImageBitmaps)
            if (this._supportsRvfc) {
              const e = s.c3_imageBitmap;
              s.c3_imageBitmap = null, o.imageBitmap = e, e && i.push(e)
            } else n.push(createImageBitmap(s).then(e => {
              o.imageBitmap = e, i.push(e)
            }).catch(e => {
              o.imageBitmap = null
            }));
          e[t.toString()] = o
        ...
        Promise.all(n).then(() => {
          this._isRuntimeInWorker ? this.PostToRuntime("state", t, !1, i) : this._PostToRuntimeMaybeSync("state", t)
        })
      }
    };
